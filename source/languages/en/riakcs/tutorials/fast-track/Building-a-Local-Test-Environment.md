...
```
{{#1.2.0}}{add_paths, ["/usr/lib64/riak-cs/lib/riak_cs-1.2.0/ebin"]},{{/1.2.0}}{{#1.2.1}}{add_paths, ["/usr/lib64/riak-cs/lib/riak_cs-1.2.1/ebin"]},{{/1.2.1}}{{#1.3.0}}{add_paths, ["/usr/lib64/riak-cs/lib/riak_cs-1.3.0/ebin"]},{{/1.3.0}}{{#1.3.1}}{add_paths, ["/usr/lib64/riak-cs/lib/riak_cs-1.3.1/ebin"]},{{/1.3.1}}{{#1.4.0}}{add_paths, ["/usr/lib/riak-cs/lib/riak_cs-1.4.0/ebin"]},{{/1.4.0}}
