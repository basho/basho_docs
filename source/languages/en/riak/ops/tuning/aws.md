...
tune the Linux virtual memory subsystem to flush smaller amounts of data
more often. To do so, please see [[Linux system performance tuning|System Performance Tuning#Optional I/O Settings]].
