 ...
 *WARNING:* The following clustering setup will *not* be resilient to instance restarts unless deployed in Amazon VPC. For hints on how to deploy in Classic EC2, see [[AWS Performance Tuning]].
