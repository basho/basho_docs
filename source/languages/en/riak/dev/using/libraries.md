...
C# | [riak-dotnet-client](https://github.com/basho-labs/riak-dotnet-client) | [api docs](http://basho-labs.github.io/riak-dotnet-client-api/index.html), [wiki](https://github.com/basho-labs/riak-dotnet-client/wiki | [NuGet package](http://www.nuget.org/List/Packages/RiakClient), [GitHub Releases](https://github.com/basho-labs/riak-dotnet-client/releases)
