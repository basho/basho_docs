...
* [Riak Haskell Client](https://github.com/janrain/riak-haskell-client) --- A fast Haskell client library from the team at MailRank, now maintained by Janrain.
...
* [OCaml Riakc](https://github.com/orbitz/ocaml-riakc) --- ocaml-riakc from Orbitz
