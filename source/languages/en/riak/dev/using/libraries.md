...
* CorrugatedIron ([project page](http://corrugatediron.org/) |
  [source](https://github.com/DistributedNonsense/CorrugatedIron) |
  [Nuget package](http://www.nuget.org/List/Packages/CorrugatedIron))
* [Hebo](http://github.com/bubbafat/hebo) --- An experimental Riak
  client
* [Data.RiakClient](http://github.com/garethstokes/Data.RiakClient) ---
  A Riak client with Protocol Buffer support
