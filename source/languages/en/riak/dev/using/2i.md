...
```csharp
var obj = new RiakObject("default", "users", "john_smith");
obj.SetObject("...user data...", "text/plain");
...
```csharp
var riakIndexId = new RiakIndexId("users", "twitter");
RiakResult<RiakIndexResult> indexRiakResult = client.GetSecondaryIndex(riakIndexId, "jsmith123");
```
...
```csharp
var obj1Id = new RiakObjectId("indexes", "people", "larry");
var riakObject = new RiakObject(obj1Id, "My name is Larry", "text/plain");

BinIndex field1Idx = riakObject.IntIndex("field1");
field1Idx.Add("val1");

IntIndex field2Idx = riakObject.BinIndex("field2");
field2Idx.Add(1001);
...
```csharp
// The C# client will not allow you to provide invalid index names,
// because you are not required to add "_bin" or "_int" to the end of
// those names
```
...
```csharp
var objId = new RiakObjectId("mybucket", "mykey", "test value");
RiakObject obj = new RiakObject("mybucket", "mykey", "test value");
...
```csharp
var riakIndexId = new RiakIndexId("mytype", "mybucket", "field1");
...
```csharp
var riakIndexId = new RiakIndexId("mytype", "mybucket", "field2");
...
```csharp
var riakIndexId = new RiakIndexId("mytype", "tweets", "hashtags");
var options = new RiakIndexGetOptions { ReturnTerms = true };
...
```csharp
var riakIndexId = new RiakIndexId("mytype", "tweets", "hashtags");
var options = new RiakIndexGetOptions { MaxResults = 5 };
var indexRiakResult = client.GetSecondaryIndex(riakIndexId, "ri", "ru", options);
var indexResult = indexRiakResult.Value;
```
