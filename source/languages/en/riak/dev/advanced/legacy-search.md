...
{{#2.0.0+}}
<div class="info">This document refers to the now <em>deprecated</em> Riak Search. Visit [[Advanced Search]] for advanced information about the new Riak Search (codenamed Yokozuna).</div>
{{/2.0.0+}}
