...
* This document assumes you have basic knowledge of configuring and running Riak KV cluster. If not, please read our [Riak KV documentation][riak kv]. (You should not join your Redis or Spark nodes to your Riak KV cluster.)
