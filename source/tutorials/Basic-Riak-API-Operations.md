...
*What's Next? Now that we have worked a bit with the HTTP interface to Riak, let's load some sample data and run some more [advanced queries using MapReduce](Loading-Data-and-Running-MapReduce-Queries.html)*.
