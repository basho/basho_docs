...
*What's Next? You've done some basic MapReduce queries in a distributed key/value store. For the next leg of the Fast Track, let's take a look at [Links and Link Walking](Links-and-Link-Walking.html)*.
