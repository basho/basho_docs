...
[describe]: /riak/ts/1.5.2/using/querying/describe/
[delete]: /riak/ts/1.5.2/using/querying/delete/
[explain]: /riak/ts/1.5.2/using/querying/explain/
[show tables]: /riak/ts/1.5.2/using/querying/show-tables/
[create table]: /riak/ts/1.5.2/using/creating-activating/
[group by]: /riak/ts/1.5.2/using/querying/select/group-by/
[order by]: /riak/ts/1.5.2/using/querying/select/order-by/
[limit]: /riak/ts/1.5.2/using/querying/select/limit/
[offset]: /riak/ts/1.5.2/using/querying/select/
[arithmetic]: /riak/ts/1.5.2/using/querying/select/arithmetic-operations/
[aggregate]: /riak/ts/1.5.2/using/querying/select/aggregate-functions/
