...
aliases:
    - /riak/ts/1.6.0/using/arithmetic-operations
    - /riakts/1.6.0/using/arithmetic-operations
    - /riakts/1.6.0/using/querying/select/arithmetic-operations
---


[querying select]: /riak/ts/1.6.0/using/querying/#select-query
