...
version_history:
  in: "1.3.0+"
  locations:
    - [">=1.6.0", "configuring/mdc"]
    - ["<=1.4.0",  "using/mdc"]
aliases:
    - /riakts/1.6.0/configuring/mdc
canonical_link: "https://docs.basho.com/riak/ts/latest/configuring/mdc"
---


[activating]: /riak/ts/1.6.0/using/creating-activating
...
{{% note title="Tip" %}}
[`SHOW CREATE TABLE`](/riak/ts/1.6.0/using/querying/show-create-table/) makes this much easier.
{{% /note %}}
