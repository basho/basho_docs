...
aliases:
    - /riakts/1.6.0/installing/debian-ubuntu/
    - /riakts/1.6.0/setup/installing/debian-ubuntu/
    - /riak/ts/1.6.0/installing/debian-ubuntu/
...
[security basics pam]: /riak/ts/1.6.0/using/security/sources-management/#pam-based-authentication
...
```bash
sudo dpkg -i riak-ts_1.6.0-1_amd64.deb
```
