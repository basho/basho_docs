...
aliases:
    - /riakts/1.6.0/installing/rhel-centos/
    - /riakts/1.6.0/setup/installing/rhel-centos/
    - /riak/ts/1.6.0/installing/rhel-centos/
...
```bash
sudo yum install riak-ts-1.6.0-1.el6.x86_64.rpm
```

or

```bash
sudo rpm -Uvh riak-ts-1.6.0-1.el6.x86_64.rpm
```
...
```bash
sudo yum install riak-ts-1.6.0-1.el7.centos.x86_64.rpm
```

or

```bash
sudo rpm -Uvh riak-ts-1.6.0-1.el7.centos.x86_64.rpm
```
