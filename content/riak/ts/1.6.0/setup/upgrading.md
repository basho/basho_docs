...
description: "Upgrading from Riak TS 1.4.0 to 1.6.0"
menu:
  riak_ts-1.6.0:
    name: "Upgrade"
    identifier: "upgrade"
...
version_history:
  present_from: "1.4.0+"
aliases:
    - /riakts/1.6.0/setup/upgrading/
    - /riakts/1.6.0/upgrading/
...
{{% note title="**CAUTION**" %}}
At the moment, there is no downgrade path between Riak TS 1.6.0 and Riak TS 1.4.0. Any data written to TS 1.6.0 will not be readable by TS 1.4.0. Please perform backups before you upgrade and be very sure you are ready to upgrade entirely before doing so.
{{% /note %}}

This page walks you through the process of upgrading to Riak TS 1.6.0 from Riak TS 1.4.0. Find your operating system below:
