...
[iso8601 accuracy]: {{<baseurl>}}riak/ts/1.5.1/using/timerepresentations/#reduced-accuracy
[ISO 8601]: https://en.wikipedia.org/wiki/ISO_8601
[learn timestamps accuracy]: {{<baseurl>}}riak/ts/1.5.1/learn-about/timestamps/#reduced-accuracy
