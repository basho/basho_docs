...
[describe]: {{<baseurl>}}riak/ts/3.0.0/using/querying/describe/
[delete]: {{<baseurl>}}riak/ts/3.0.0/using/querying/delete/
[explain]: {{<baseurl>}}riak/ts/3.0.0/using/querying/explain/
[show tables]: {{<baseurl>}}riak/ts/3.0.0/using/querying/show-tables/
[create table]: {{<baseurl>}}riak/ts/3.0.0/using/creating-activating/
[group by]: {{<baseurl>}}riak/ts/3.0.0/using/querying/select/group-by/
[order by]: {{<baseurl>}}riak/ts/3.0.0/using/querying/select/order-by/
[limit]: {{<baseurl>}}riak/ts/3.0.0/using/querying/select/limit/
[offset]: {{<baseurl>}}riak/ts/3.0.0/using/querying/select/
[arithmetic]: {{<baseurl>}}riak/ts/3.0.0/using/querying/select/arithmetic-operations/
[aggregate]: {{<baseurl>}}riak/ts/3.0.0/using/querying/select/aggregate-functions/
