...
[SELECT]: {{<baseurl>}}riak/ts/3.0.0/using/querying/SELECT#iso_8601
...
It is possible to use ISO 8601-compliant date/time strings rather than integer timestamps in SELECT statements. Please see [SELECT]({{<baseurl>}}riak/ts/3.0.0/using/querying/select/#iso-8601) for an example or [Time Representations]({{<baseurl>}}riak/ts/1.5.2/using/timerepresentations/) for more information.
{{% /note %}}
