...
aliases:
  ...
  - /riak/kv/3.0.4/dev/using/conflict-resolution/ruby
---
...
the official Ruby client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/3.0.4/developing/usage) section.
