...
aliases:
  ...
  - /riak/kv/2.9.8/dev/using/conflict-resolution/java
---
...
the official Java client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/2.9.8/developing/usage) section.
