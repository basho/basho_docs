...
aliases:
  ...
  - /riak/kv/2.9.8/dev/using/conflict-resolution/python
---
...
application will be stored in buckets that bear the [bucket type]({{<baseurl>}}riak/kv/2.9.8/developing/usage/bucket-types) `siblings`, and for this bucket type `allow_mult` is set
...
from the official Python client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/2.9.8/developing/usage) section.
