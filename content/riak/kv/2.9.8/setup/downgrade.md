...
aliases:
  ...
  - /riak/kv/2.9.8/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/2.9.8/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/2.9.8/using/admin/riak-admin/#aae-status
