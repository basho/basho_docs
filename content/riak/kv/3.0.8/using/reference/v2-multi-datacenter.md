...
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}riak/kv/3.0.8/using/reference/v3-multi-datacenter/) instead.
{{% /note %}}
