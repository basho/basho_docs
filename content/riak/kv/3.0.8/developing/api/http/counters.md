...
aliases:
  ...
  - /riak/kv/3.0.8/dev/references/http/counters
---
...
The regular POST/PUT ([HTTP Store Object]({{<baseurl>}}riak/kv/3.0.8/developing/api/http/store-object)) and GET ([HTTP Fetch Object]({{<baseurl>}}riak/kv/3.0.8/developing/api/http/fetch-object)) responses apply here.
