...
aliases:
  ...
  - /riak/kv/3.0.8/dev/advanced/write-once
---
...
[strong consistency]: {{<baseurl>}}riak/kv/3.0.8/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}riak/kv/3.0.8/setup/planning/backend/multi) backend does not
