...
toc: true
aliases:
  - /riak/3.0.8/ops/advanced/configs/search/
  - /riak/kv/3.0.8/ops/advanced/configs/search/
---

[usage search]: {{<baseurl>}}riak/kv/3.0.8/developing/usage/search
[usage search schema]: {{<baseurl>}}riak/kv/3.0.8/developing/usage/search-schemas
[usage search data types]: {{<baseurl>}}riak/kv/3.0.8/developing/usage/searching-data-types
[usage custom extractors]: {{<baseurl>}}riak/kv/3.0.8/developing/usage/custom-extractors
[cluster-ops aae throttle]: {{<baseurl>}}riak/kv/3.0.8/using/cluster-operations/active-anti-entropy/#throttling
[config reference]: {{<baseurl>}}riak/kv/3.0.8/configuring/reference
[config reference#search]: {{<baseurl>}}riak/kv/3.0.8/configuring/reference/#search
