...
[strong consistency]: {{<baseurl>}}riak/kv/2.9.2/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}riak/kv/2.9.2/setup/planning/backend/multi) backend does not
