...
on specifying trusted CIDRs can be found in [Trust-based Authentication]({{<baseurl>}}riak/kv/2.9.2/using/security/managing-sources/#trust-based-authentication).
