...
aliases:
  ...
  - /riak/kv/2.9.2/dev/references/http/link-walking
---
...
is a special case of [MapReduce]({{<baseurl>}}riak/kv/2.9.2/developing/usage/mapreduce), and can be expressed more verbosely as such.
[Read more about Links]({{<baseurl>}}riak/kv/2.9.2/learn/glossary/#links).
...
response from [fetching the object]({{<baseurl>}}riak/kv/2.9.2/developing/api/http/fetch-object), without the status
code.
