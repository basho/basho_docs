...
aliases:
  ...
  - /riak/kv/2.9.2/dev/references/protocol-buffers/yz-schema-get
---

Fetch a [search schema]({{<baseurl>}}riak/kv/2.9.2/developing/usage/search-schemas) from Riak Search.
