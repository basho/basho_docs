...
[concept causal context vc]: {{<baseurl>}}riak/kv/2.9.2/learn/concepts/causal-context/#vector-clocks
[concept clusters]: {{<baseurl>}}riak/kv/2.9.2/learn/concepts/clusters
[concept vnodes]: {{<baseurl>}}riak/kv/2.9.2/learn/concepts/vnodes
[glossary node]: {{<baseurl>}}riak/kv/2.9.2/learn/glossary/#node
...
bucket's [bucket type]({{<baseurl>}}riak/kv/2.9.2/developing/usage/bucket-types).
...
[Multi-Datacenter Replications]({{<baseurl>}}riak/kv/2.9.2/setup/planning/backend/multi) capabilities.
...
type]({{<baseurl>}}riak/kv/2.9.2/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index]({{<baseurl>}}riak/kv/2.9.2/developing/usage/secondary-indexes/) and
[MapReduce]({{<baseurl>}}riak/kv/2.9.2/developing/usage/mapreduce/) queries. Lowering an object or bucket's
