...
aliases:
  ...
  - /riak/kv/2.9.2/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/2.9.2/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/2.9.2/using/admin/riak-admin/#aae-status
