...
version_history:
  in: "2.9.1+"
aliases:
  - /riak/kv/2.9.2/ops/advanced/aae/
  - /riak/2.9.2/ops/advanced/aae/
---
[config search#throttledelay]: {{<baseurl>}}riak/kv/2.9.2/configuring/search/#search-anti-entropy-throttle-tier-delay
[config search#throttle]: {{<baseurl>}}riak/kv/2.9.2/configuring/search/#search-anti-entropy-throttle
...
In Riak versions 2.9.1 and later, [TicTac AAE]({{<baseurl>}}riak/kv/2.9.2/using/cluster-operations/tictac-active-anti-entropy/) is included with releases as an option to be used in addition to or instead of traditional AAE in Riak.
