...
object ([default is defined by the bucket](/riak/kv/2.0.4/developing/api/http/set-bucket-props))
* `pr` - how many primary replicas need to be online when doing the read
([default is defined by the bucket](/riak/kv/2.0.4/developing/api/http/set-bucket-props))
