...
treatment of how CRDTs work in Riak, see our [Data Types](/riak/kv/2.0.4/developing/data-types/) doc.
...
[below](/riak/kv/2.0.4/developing/data-types/#Maps).
...
In order to use Riak Data Types, you must first create a [bucket type](/riak/kv/2.0.4/developing/usage/bucket-types) that sets the `datatype` bucket parameter to
...
documentation we offer a [full tutorial](/riak/kv/2.0.4/developing/usage/searching-data-types) as well as a variety of
[examples](/riak/kv/2.0.4/developing/usage/search/#Data-Types-and-Search-Examples), including code
...
set, which provides our client access to the set's [causal context](/riak/kv/2.0.4/learn/concepts/causal-context).
...
[causal context](/riak/kv/2.0.4/learn/concepts/causal-context), which enables Riak to make intelligent decisions
...
Data Type contexts are similar to [causal context](/riak/kv/2.0.4/learn/concepts/causal-context) in that they are
