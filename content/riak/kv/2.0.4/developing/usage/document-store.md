...
canonical_link: "docs.basho.com/riak/kv/latest/developing/usage/document-store.md"
---
...
In the documentation on [search schemas](/riak/kv/2.0.4/developing/usage/search-schemas), you'll find a
...
described in [Data Modeling with Riak Data Types](/riak/kv/2.0.4/developing/data-modeling), we can construct a
