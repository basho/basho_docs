...
[config reference#strong-cons]: /riak/kv/2.0.4/configuring/reference/#strong-consistency
...
[use admin riak-admin#ensemble]: /riak/kv/2.0.4/using/admin/riak-admin/#riak-admin-ensemble-status
