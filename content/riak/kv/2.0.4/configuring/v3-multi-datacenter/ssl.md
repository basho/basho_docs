...
canonical_link: "docs.basho.com/riak/kv/latest/configuring/v3-multi-datacenter/ssl.md"
---

[config reference#advanced.config]: /riak/kv/2.0.4/configuring/reference/#the-advanced-config-file
