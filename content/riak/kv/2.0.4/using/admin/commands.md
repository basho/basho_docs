...
[use admin riak-admin#cluster-plan]: /riak/kv/2.0.4/using/admin/riak-admin/#cluster-plan
[use admin riak-admin#cluster-commit]: /riak/kv/2.0.4/using/admin/riak-admin/#cluster-commit
