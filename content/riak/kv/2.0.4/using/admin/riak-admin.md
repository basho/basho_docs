...
aliases:
  ...
  - /riak/kv/2.0.4/ops/running/tools/riak-admin
canonical_link: "docs.basho.com/riak/kv/latest/using/admin/riak-admin"
---

[config reference]: /riak/kv/2.0.4/configuring/reference
[use admin commands]: /riak/kv/2.0.4/using/admin/commands
[use admin commands#join]: /riak/kv/2.0.4/using/admin/commands/#join
[use admin commands#leave]: /riak/kv/2.0.4/using/admin/commands/#leave
[cluster ops backup]: /riak/kv/2.0.4/using/cluster-operations/backing-up
[config reference#node-metadata]: /riak/kv/2.0.4/configuring/reference/#node-metadata
...
[config reference#ring]: /riak/kv/2.0.4/configuring/reference/#ring
...
[downgrade]: /riak/kv/2.0.4/setup/upgrading/downgrade
...
[use admin riak-admin#stats]: /riak/kv/2.0.4/using/admin/riak-admin/#stats
