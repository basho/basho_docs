...
participate in realtime replication. Please see the [Riak Enterprise MDC Replication Configuration]({{<baseurl>}}riak/kv/2.0.4/configuring/v2-multi-datacenter/) guide for more information.
