...
toc: true
canonical_link: "docs.basho.com/riak/kv/latest/using/cluster-operations/adding-removing-nodes.md"
---
...
simply the script [`riak`](/riak/kv/2.0.4/using/admin/riak-cli/):
