...
issues with [Riak Data Types](/riak/kv/2.0.4/developing/data-types) upon upgrading from Riak
2.0.2 to 2.0.4. It was discovered that keys storing [Riak maps](/riak/kv/2.0.4/developing/data-types/#Maps) are unreadable after upgrading due to a change in the
...
your cluster's [logs](/riak/kv/2.0.4/using/cluster-operations/logging). You will see errors along the following
...
The recommended mitigation strategy is to upgrade to [Riak 2.0.4 or
