...
[concept clusters ring]: /riak/kv/2.0.4/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask](/riak/kv/2.0.4/setup/planning/backend/bitcask) as a backend, navigate
