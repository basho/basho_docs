...
aliases:
  ...
  - /riak/kv/2.0.4/theory/concepts/Replication
  - /riak/2.0.4/theory/concepts/replication
  - /riak/kv/2.0.4/theory/concepts/replication
---
...
[glossary node]: {{<baseurl>}}riak/kv/2.0.4/learn/glossary/#node
...
bucket's [bucket type]({{<baseurl>}}riak/kv/2.0.4/developing/usage/bucket-types).
...
[Multi-Datacenter Replications]({{<baseurl>}}riak/kv/2.0.4/setup/planning/backend/multi) capabilities.
...
type]({{<baseurl>}}riak/kv/2.0.4/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index]({{<baseurl>}}riak/kv/2.0.4/developing/usage/secondary-indexes/) and
[MapReduce]({{<baseurl>}}riak/kv/2.0.4/developing/usage/mapreduce/) queries. Lowering an object or bucket's
