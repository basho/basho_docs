...
[concept causal context dvv]: {{<baseurl>}}riak/kv/2.0.4/learn/concepts/causal-context/#dotted-version-vectors
...
indexes]({{<baseurl>}}riak/kv/2.0.4/developing/usage/secondary-indexes/) and [Search]({{<baseurl>}}riak/kv/2.0.4/developing/usage/search/).
...
object]({{<baseurl>}}riak/kv/2.0.4/developing/data-types/#Data-Types-and-Context) that is similar to a
