...
aliases:
  ...
  - /riak/kv/2.0.4/theory/concepts/context
---
...
[dev key value]: {{<baseurl>}}riak/kv/2.0.4/developing/key-value-modeling
[glossary read rep]: {{<baseurl>}}riak/kv/2.0.4/learn/glossary/#read-repair
[perf latency reduc]: {{<baseurl>}}riak/kv/2.0.4/using/performance/latency-reduction
...
[usage protocol buffers]: {{<baseurl>}}riak/kv/2.0.4/developing/api/protocol-buffers
[usage updating objects]: {{<baseurl>}}riak/kv/2.0.4/developing/usage/updating-objects
...
[using bucket types]({{<baseurl>}}riak/kv/2.0.4/developing/usage/bucket-types), all writes to that bucket will create siblings
