...
aliases:
  ...
  - /riak/kv/3.0.16/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/3.0.16/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/3.0.16/using/admin/riak-admin/#aae-status
