...
aliases:
  ...
  - /riak/kv/3.0.16/dev/advanced/write-once
---
...
[Riak data types]: {{<baseurl>}}riak/kv/3.0.16/developing/data-types
[strong consistency]: {{<baseurl>}}riak/kv/3.0.16/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}riak/kv/3.0.16/setup/planning/backend/multi) backend does not
