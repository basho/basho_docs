...
aliases:
  ...
  - /riak/kv/3.0.16/ops/mdc/v3/configuration
---

[config reference#advanced]: {{<baseurl>}}riak/kv/3.0.16/configuring/reference/#advanced-configuration
[config v3 ssl#verify-peer]: {{<baseurl>}}riak/kv/3.0.16/configuring/v3-multi-datacenter/ssl/#verifying-peer-certificates
