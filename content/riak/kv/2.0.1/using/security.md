...
[config reference search]: {{<baseurl>}}riak/kv/2.0.1/configuring/reference/#search
[config search enabling]: {{<baseurl>}}riak/kv/2.0.1/configuring/search/#enabling-riak-search
