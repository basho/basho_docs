...
consistency involves a complex [consensus subsystem](/riak/kv/2.0.1/learn/concepts/strong-consistency/#implementation-details) that typically requires more communication between Riak nodes than eventually consistent operations,
