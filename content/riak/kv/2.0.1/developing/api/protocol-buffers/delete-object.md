...
aliases:
  ...
  - /riak/kv/2.0.1/dev/references/protocol-buffers/delete-object
---

Delete an object in the specified [bucket type]({{<baseurl>}}riak/kv/2.0.1/using/cluster-operations/bucket-types)/bucket/key location.
