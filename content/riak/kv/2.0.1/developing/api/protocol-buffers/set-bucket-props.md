...
[PBC Get Bucket Properties]({{<baseurl>}}riak/kv/2.0.1/developing/api/protocol-buffers/get-bucket-props) documentation.

You can also specify a [bucket type]({{<baseurl>}}riak/kv/2.0.1/developing/usage/bucket-types) using the
