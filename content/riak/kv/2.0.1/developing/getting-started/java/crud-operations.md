...
Riak, see [Updating Objects]({{<baseurl>}}riak/kv/2.0.1/developing/usage/updating-objects/)
and [Conflict Resolution]({{<baseurl>}}riak/kv/2.0.1/developing/usage/conflict-resolution/)
documentation.
