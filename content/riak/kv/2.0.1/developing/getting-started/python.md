...
aliases:
  ...
  - /riak/kv/2.0.1/dev/taste-of-riak/python
---



If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}riak/kv/2.0.1/using/running-a-cluster) first.
...
[CRUD Operations]({{<baseurl>}}riak/kv/2.0.1/developing/getting-started/python/crud-operations)
