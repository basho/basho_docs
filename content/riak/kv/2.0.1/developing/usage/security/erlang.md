...
on specifying trusted CIDRs can be found in [Trust-based Authentication](/riak/kv/2.0.1/using/security/managing-sources/#Trust-based-Authentication).
