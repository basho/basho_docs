...
[Bucket Properties]: {{<baseurl>}}riak/kv/2.0.1/developing/usage
[built-in functions list]: https://github.com/basho/riak_kv/blob/master/priv/mapred_builtins.js
[commit hooks]: {{<baseurl>}}riak/kv/2.0.1/developing/usage/commit-hooks
...
[Erlang Riak Client]: {{<baseurl>}}riak/kv/2.0.1/developing/client-libraries
...
[System Planning]: {{<baseurl>}}riak/kv/2.0.1/setup/planning/start/#network-configuration-load-balancing
[vector clocks]: {{<baseurl>}}riak/kv/2.0.1/learn/concepts/causal-context#vector-clocks
