...
aliases:
  ...
  - /riak/kv/2.0.1/theory/concepts/Replication
  - /riak/2.0.1/theory/concepts/replication
  - /riak/kv/2.0.1/theory/concepts/replication
...
[concept causal context vc]: /riak/kv/2.0.1/learn/concepts/causal-context/#vector-clocks
...
[usage replication]: /riak/kv/2.0.1/developing/usage/replication
...
bucket's [bucket type](/riak/kv/2.0.1/developing/usage/bucket-types).
...
[Multi-Datacenter Replications](/riak/kv/2.0.1/setup/planning/backend/multi) capabilities.
...
type](/riak/kv/2.0.1/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index](/riak/kv/2.0.1/developing/usage/secondary-indexes/) and
[MapReduce](/riak/kv/2.0.1/developing/usage/mapreduce/) queries. Lowering an object or bucket's
