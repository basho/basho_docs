...
[dev key value]: /riak/kv/2.0.1/developing/key-value-modeling
[glossary read rep]: /riak/kv/2.0.1/learn/glossary/#read-repair
[perf latency reduc]: /riak/kv/2.0.1/using/performance/latency-reduction
...
[usage protocol buffers]: /riak/kv/2.0.1/developing/api/protocol-buffers
...
[using bucket types](/riak/kv/2.0.1/developing/usage/bucket-types), all writes to that bucket will create siblings
