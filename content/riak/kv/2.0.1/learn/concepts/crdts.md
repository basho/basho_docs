...
indexes]({{<baseurl>}}riak/kv/2.0.1/developing/usage/secondary-indexes/) and [Search]({{<baseurl>}}riak/kv/2.0.1/developing/usage/search/).
...
object]({{<baseurl>}}riak/kv/2.0.1/developing/data-types/#Data-Types-and-Context) that is similar to a
