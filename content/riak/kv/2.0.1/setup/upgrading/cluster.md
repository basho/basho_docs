...
[production checklist]: /riak/kv/2.0.1/setup/upgrading/checklist
...
[release notes]: /riak/kv/2.0.1/release-notes/
...
[jmx monitor]: /riak/kv/2.0.1/using/reference/jmx
[snmp]: /riak/kv/2.0.1/using/reference/snmp
...
If you run [Riak Control](/riak/kv/2.0.1/using/admin/riak-control), you should disable it during the rolling upgrade process.
{{% /note %}}
...
If you use Riak KV's [secondary indexes](/riak/kv/2.0.1/developing/usage/secondary-indexes) and are
upgrading from a version prior to Riak KV version 1.3.1, you need to
reformat the indexes using the [`riak-admin reformat-indexes`](/riak/kv/2.0.1/using/admin/riak-admin) command. More details about reformatting indexes are available in the [release notes](/riak/kv/2.0.1/release-notes/).
{{% /note %}}
