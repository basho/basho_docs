...
Provides information about the current [configuration](/riak/kv/2.2.0/configuring/reference/) of a Riak node, i.e. the parameters and values in the node's `riak.conf` configuation.
