...
[Bucket Properties]: {{<baseurl>}}riak/kv/2.2.0/developing/usage
[built-in functions list]: https://github.com/basho/riak_kv/blob/master/priv/mapred_builtins.js
[commit hooks]: {{<baseurl>}}riak/kv/2.2.0/developing/usage/commit-hooks
[Configuration Files]: {{<baseurl>}}riak/kv/2.2.0/configuring/reference
[contrib.basho.com]: https://github.com/basho/riak_function_contrib
[Erlang Riak Client]: {{<baseurl>}}riak/kv/2.2.0/developing/client-libraries
