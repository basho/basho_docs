...
Create a new Solr [search schema]({{<baseurl>}}riak/kv/2.2.0/developing/usage/search-schemas).
...
This message *must* include both the schema `name` and its Solr [search schema]({{<baseurl>}}riak/kv/2.2.0/developing/usage/search-schemas) `content` as XML.
