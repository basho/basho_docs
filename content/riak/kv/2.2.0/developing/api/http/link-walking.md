...
[Read more about Links](/riak/kv/2.2.0/learn/glossary/#links).
...
response from [fetching the object](/riak/kv/2.2.0/developing/api/http/fetch-object), without the status
code.
