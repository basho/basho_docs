...
Creates a new Riak [Search schema](/riak/kv/2.2.0/developing/usage/search-schemas).
...
formed XML schema. More information can be found in the [Search Schema](/riak/kv/2.2.0/developing/usage/search-schemas) document. If you've created a schema and stored it in the filed
