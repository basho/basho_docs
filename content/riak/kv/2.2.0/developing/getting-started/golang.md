...
If you haven't set up a Riak Node and started it, please visit [Running A Cluster](/riak/kv/2.2.0/using/running-a-cluster) first and ensure you have
...
[CRUD Operations](/riak/kv/2.2.0/developing/getting-started/golang/crud-operations)
