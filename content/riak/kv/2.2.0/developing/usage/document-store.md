...
In the documentation on [search schemas](/riak/kv/2.2.0/developing/usage/search-schemas), you'll find a
...
described in [Data Modeling with Riak Data Types](/riak/kv/2.2.0/developing/data-modeling), we can construct a
