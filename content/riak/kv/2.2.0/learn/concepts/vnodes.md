...
[concept clusters ring]: /riak/kv/2.2.0/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask](/riak/kv/2.2.0/setup/planning/backend/bitcask) as a backend, navigate
