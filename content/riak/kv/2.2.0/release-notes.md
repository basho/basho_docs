...
* We've also updated the Riak KV distribution on the Amazon Linux AMI to 2.2.0! Our AMI is built upon Amazon Linux 2015.03. Due to Amazon's processes, it will take several days after the release of 2.2.0 to show up on Amazon.
