...
[concept clusters ring]: {{<baseurl>}}riak/kv/2.9.1/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}riak/kv/2.9.1/setup/planning/backend/bitcask) as a backend, navigate
