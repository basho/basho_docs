...
aliases:
  ...
  - /riak/kv/2.9.1/dev/advanced/search
---

[concept clusters]: {{<baseurl>}}riak/kv/2.9.1/learn/concepts/clusters
[configuring search]: {{<baseurl>}}riak/kv/2.9.1/configuring/search
...
search, you should check out the [Using Search]({{<baseurl>}}riak/kv/2.9.1/developing/usage/search) document.
...
See the [main Search documentation]({{<baseurl>}}riak/kv/2.9.1/developing/usage/search/#simple-setup) for details on creating an index.
...
[Active Anti-Entropy]({{<baseurl>}}riak/kv/2.9.1/learn/concepts/active-anti-entropy/) \(AAE) is the process of discovering and
...
information on analysis, see [Search Schema]({{<baseurl>}}riak/kv/2.9.1/developing/usage/search-schemas).
