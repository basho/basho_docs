...
aliases:
  ...
  - /riak/kv/2.9.1/dev/using/conflict-resolution/ruby
---
...
the official Ruby client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/2.9.1/developing/usage) section.
