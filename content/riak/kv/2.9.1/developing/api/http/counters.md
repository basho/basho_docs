...
The regular POST/PUT ([HTTP Store Object]({{<baseurl>}}riak/kv/2.9.1/developing/api/http/store-object)) and GET ([HTTP Fetch Object]({{<baseurl>}}riak/kv/2.9.1/developing/api/http/fetch-object)) responses apply here.
