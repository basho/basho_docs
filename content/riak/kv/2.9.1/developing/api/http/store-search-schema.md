...
formed XML schema. More information can be found in the [Search Schema]({{<baseurl>}}riak/kv/2.9.1/developing/usage/search-schemas) document. If you've created a schema and stored it in the filed
