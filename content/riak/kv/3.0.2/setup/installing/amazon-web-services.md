...
aliases:
  ...
  - /riak/kv/3.0.2/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak/3.0.2/installing/amazon-web-services/
  - /riak/kv/3.0.2/installing/amazon-web-services/
---
...
We also recommend that you read more about Riak's [Security and Firewalls]({{<baseurl>}}riak/kv/3.0.2/using/security/).
