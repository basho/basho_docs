...
aliases:
  ...
  - /riak/kv/3.0.2/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/3.0.2/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/3.0.2/using/admin/riak-admin/#aae-status
