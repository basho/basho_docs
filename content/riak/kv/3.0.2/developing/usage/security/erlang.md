...
on specifying trusted CIDRs can be found in [Trust-based Authentication]({{<baseurl>}}riak/kv/3.0.2/using/security/managing-sources/#trust-based-authentication).
