...
aliases:
  ...
  - /riak/kv/3.0.9/ops/building/installing/Installing-on-AWS-Marketplace
...
We also recommend that you read more about Riak's [Security and Firewalls]({{<baseurl>}}riak/kv/3.0.9/using/security/).
