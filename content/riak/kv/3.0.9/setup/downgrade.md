...
aliases:
  ...
  - /riak/kv/3.0.9/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/3.0.9/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/3.0.9/using/admin/riak admin/#aae-status
