...
that can be useful in application development, such as [secondary indexes (2i)]({{<baseurl>}}riak/kv/3.0.9/developing/usage/secondary-indexes/), and [Riak Data Types]({{<baseurl>}}riak/kv/3.0.9/developing/data-types/), Riak almost always performs best when you
