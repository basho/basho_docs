...
toc: true
aliases:
  - /riak/3.0.9/dev/references/http/store-search-schema
  - /riak/kv/3.0.9/dev/references/http/store-search-schema
---

Creates a new Riak [Search schema]({{<baseurl>}}riak/kv/3.0.9/developing/usage/search-schemas).
...
formed XML schema. More information can be found in the [Search Schema]({{<baseurl>}}riak/kv/3.0.9/developing/usage/search-schemas) document. If you've created a schema and stored it in the filed
