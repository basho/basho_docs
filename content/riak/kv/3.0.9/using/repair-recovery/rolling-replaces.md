...
[upgrade]: {{<baseurl>}}riak/kv/3.0.9/setup/upgrading/cluster/
[rolling restarts]: {{<baseurl>}}riak/kv/3.0.9/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}riak/kv/3.0.9/using/cluster-operations/adding-removing-nodes
