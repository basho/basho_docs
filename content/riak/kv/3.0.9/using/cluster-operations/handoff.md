...
This command displays the values for handoff-specific [configurable parameters]({{<baseurl>}}riak/kv/3.0.9/configuring/reference/#intra-cluster-handoff) on each node in
