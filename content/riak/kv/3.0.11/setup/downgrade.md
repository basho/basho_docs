...
aliases:
  ...
  - /riak/kv/3.0.11/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/3.0.11/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/3.0.11/using/admin/riak-admin/#aae-status
