...
aliases:
  ...
  - /riak/kv/3.0.11/ops/upgrading/rolling-upgrades/
  - /riak/kv/3.0.11/ops/upgrading/rolling-upgrades/
  - /riak/kv/3.0.11/setup/upgrading/cluster/

---


[production checklist]: {{<baseurl>}}riak/kv/3.0.11/setup/upgrading/checklist
...
[release notes]: {{<baseurl>}}riak/kv/3.0.11/release-notes
...
[jmx monitor]: {{<baseurl>}}riak/kv/3.0.11/using/reference/jmx
[snmp]: {{<baseurl>}}riak/kv/3.0.11/using/reference/snmp
[Release Notes]: {{<baseurl>}}riak/kv/3.0.11/release-notes
...
{{% note %}}
You must have [Java version 7 or higher](http://www.oracle.com/technetwork/java/javase/downloads/index.html) in order to upgrade to Riak KV 3.0.11 only if you plan to use Riak search.
{{% /note %}}
...
{{% note %}}
You must have [Java version 7 or higher](http://www.oracle.com/technetwork/java/javase/downloads/index.html) in order to upgrade to Riak KV 3.0.11 if you wish to use Riak search. If you do not have it installed, please install it now.
{{% /note %}}
