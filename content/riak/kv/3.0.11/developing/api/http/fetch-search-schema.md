...
toc: true
aliases:
  - /riak/3.0.11/dev/references/http/fetch-search-schema
  - /riak/kv/3.0.11/dev/references/http/fetch-search-schema
---

Retrieves a Riak KV [search schema]({{<baseurl>}}riak/kv/3.0.11/developing/usage/search-schemas).
