...
aliases:
  ...
  - /riak/kv/3.0.11/dev/taste-of-riak/erlang
---

If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}riak/kv/3.0.11/using/running-a-cluster) first.
...
[CRUD Operations]({{<baseurl>}}riak/kv/3.0.11/developing/getting-started/erlang/crud-operations)
