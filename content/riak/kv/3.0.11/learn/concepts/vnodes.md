...
aliases:
  ...
  - /riak/kv/3.0.11/theory/concepts/vnodes
---

[concept causal context]: {{<baseurl>}}riak/kv/3.0.11/learn/concepts/causal-context
[concept clusters ring]: {{<baseurl>}}riak/kv/3.0.11/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}riak/kv/3.0.11/setup/planning/backend/bitcask) as a backend, navigate
