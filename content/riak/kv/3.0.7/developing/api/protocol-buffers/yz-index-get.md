...
toc: true
aliases:
  - /riak/3.0.7/dev/references/protocol-buffers/yz-index-get
  - /riak/kv/3.0.7/dev/references/protocol-buffers/yz-index-get
---
...
binary (as `name`). Optionally, you can specify a [`schema`]({{<baseurl>}}riak/kv/3.0.7/developing/usage/search-schemas) name and/or an `n_val`, i.e. the number of nodes on which the
