...
aliases:
  ...
  - /riak/kv/3.0.7/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak/3.0.7/installing/amazon-web-services/
  - /riak/kv/3.0.7/installing/amazon-web-services/
---
...
We also recommend that you read more about Riak's [Security and Firewalls]({{<baseurl>}}riak/kv/3.0.7/using/security/).
