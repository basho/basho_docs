...
Riak, see [Updating Objects]({{<baseurl>}}riak/kv/2.0.2/developing/usage/updating-objects/)
and [Conflict Resolution]({{<baseurl>}}riak/kv/2.0.2/developing/usage/conflict-resolution/)
documentation.
