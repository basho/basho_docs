...
The regular POST/PUT ([HTTP Store Object]({{<baseurl>}}riak/kv/2.0.2/developing/api/http/store-object)) and GET ([HTTP Fetch Object]({{<baseurl>}}riak/kv/2.0.2/developing/api/http/fetch-object)) responses apply here.
