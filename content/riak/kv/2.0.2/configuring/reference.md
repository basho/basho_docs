...
<td>The directory in which the <a href="/riak/kv/2.0.2/using/admin/riak-admin"><code>riak-admin</code></a>,
...
as <a href="/riak/kv/2.0.2/learn/concepts/clusters">ring state</a> data, <a href="/riak/kv/2.0.2/learn/glossary/#active-anti-entropy-aae">active anti-entropy</a> data, and cluster metadata.</td>
...
<br /><br />
<strong>Note</strong>: See <a href="/riak/kv/2.0.2/developing/usage/conflict-resolution">
...
such as <a href="dev/using/search">Riak Search</a>, can block <a href="/riak/kv/2.0.2/using/cluster-operations/handoff">handoff</a>
...
<td>Whether serialized <a href="/riak/kv/2.0.2/developing/data-types">Data Types</a> will use compression and at what
...
associated <a href="/riak/kv/2.0.2/learn/glossary/#vnode">vnode</a> before assuming that the vnode
