...
aliases:
  ...
  - /riak/2.1.3/theory/concepts/replication
canonical_link: "docs.basho.com/riak/kv/latest/learn/concepts/replication.md"
---
...
[concept causal context vc]: /riak/kv/2.0.2/concepts/causal-context/#vector-clocks
...
[glossary ring]: /riak/kv/2.0.2/learn/glossary/#ring
[usage replication]: /riak/kv/2.0.2/developing/usage/replication
...
bucket's [bucket type](/riak/kv/2.0.2/developing/usage/bucket-types).
...
[Multi-Datacenter Replications](/riak/kv/2.0.2/setup/planning/backend/multi) capabilities.
...
type](/riak/kv/2.0.2/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index](/riak/kv/2.0.2/developing/usage/secondary-indexes/) and
[MapReduce](/riak/kv/2.0.2/developing/usage/mapreduce/) queries. Lowering an object or bucket's
