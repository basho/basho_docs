...
[concept clusters ring]: {{<baseurl>}}riak/kv/2.0.2/learn/concepts/clusters/#the-ring
...
[perf strong consistency]: {{<baseurl>}}riak/kv/2.0.2/using/reference/strong-consistency
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}riak/kv/2.0.2/setup/planning/backend/bitcask) as a backend, navigate
