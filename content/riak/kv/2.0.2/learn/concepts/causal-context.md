...
canonical_link: "docs.basho.com/riak/kv/latest/learn/concepts/causal-context.md"
---
...
[dev key value]: /riak/kv/2.0.2/developing/key-value-modeling
[glossary read rep]: /riak/kv/2.0.2/learn/glossary/#read-repair
[perf latency reduc]: /riak/kv/2.0.2/using/performance/latency-reduction
...
[usage protocol buffers]: /riak/kv/2.0.2/developing/api/protocol-buffers
[usage updating objects]: /riak/kv/2.0.2/developing/usage/updating-objects
...
[using bucket types](/riak/kv/2.0.2/developing/usage/bucket-types), all writes to that bucket will create siblings
