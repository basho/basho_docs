...
If you have installed Riak 2.0.2, you will not need to apply the patch,
...
To verify that the patch has been installed properly, run the [`riak attach`](/riak/kv/2.0.2/using/admin/riak-cli/#attach) command (or [`riak-cs attach`](/riak/cs/2.1.1/cookbooks/command-line-tools/#riak-cs)).
...
This patch is included in Riak 2.0.2 and all releases thereafter.
