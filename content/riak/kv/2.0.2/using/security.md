...
[Authentication and Authorization](/riak/kv/2.0.2/using/security/basics) and [Managing Security Sources](/riak/kv/2.0.2/using/security/managing-sources/)
...
authentication, please see our documentation on [Riak Security](/riak/kv/2.0.2/using/security/basics).
...
[Security and Firewalls](/riak/kv/2.0.2/using/security/basics).
...
See also: [Multi Data Center Replication: SSL](/riak/kv/2.0.2/configuring/v3-multi-datacenter/ssl) in the Enterprise
Documentation.
