...
the nodes in your Riak cluster, you need to perform a [rolling restart](/riak/kv/2.0.2/repair-recovery/rolling-restart/). Once that process is complete, you can use the client
