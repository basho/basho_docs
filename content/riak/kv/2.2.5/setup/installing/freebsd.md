...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/ops/building/installing/Installing-on-FreeBSD
  - /riak-docs/riak/kv/2.2.5/ops/building/installing/Installing-on-FreeBSD
  - /riak-docs/riak/2.2.5/installing/freebsd/
  - /riak-docs/riak/kv/2.2.5/installing/freebsd/
---
...
`pkg_add` remote option. For this example, we're installing `riak-2.2.5-FreeBSD-amd64.tbz`.

```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/2.2/2.2.5/freebsd/9/riak-2.2.5-FreeBSD-amd64.tbz
```
...
```
Package dependency openssl-1.0.0_7 for /tmp/riak-2.2.5-FreeBSD-amd64.tbz not found!
```
