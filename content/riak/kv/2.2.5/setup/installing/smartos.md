...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/ops/building/installing/Installing-on-SmartOS
  - /riak-docs/riak/kv/2.2.5/ops/building/installing/Installing-on-SmartOS
  - /riak-docs/riak/2.2.5/installing/smartos/
  - /riak-docs/riak/kv/2.2.5/installing/smartos/
---

[install verify]: {{<baseurl>}}riak/kv/2.2.5/setup/installing/verify

{{% note title="SmartOS End of Life (EOL) for Riak KV 2.2.5" %}}
SmartOS is no longer supported in Riak KV 2.2.5+. If you are interested in using Riak KV on SmartOS, you can still [build from source](../source).
{{% /note %}}
...
```bash
curl -o /tmp/riak-2.2.5-SmartOS-x86_64.tgz https://files.tiot.jp/riak/kv/2.2/2.2.5/smartos/1.8/riak-2.2.5-SmartOS-x86_64.tgz
```

Next, install the package:

```
pkg_add /tmp/riak-2.2.5-SmartOS-x86_64.tgz
```
