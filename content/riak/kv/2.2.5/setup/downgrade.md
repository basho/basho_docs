...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/ops/upgrading/rolling-downgrades/
  - /riak-docs/riak/kv/2.2.5/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/2.2.5/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/2.2.5/using/admin/riak-admin/#aae-status
...
If you enabled LZ4 compression in LevelDB and/or enabled global expiration in LevelDB when you installed KV 2.2.5, you cannot downgrade.
