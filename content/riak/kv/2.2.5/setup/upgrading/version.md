---
title: "Upgrading to Riak KV 2.2.5"
description: ""
project: "riak_kv"
project_version: "2.2.5"
menu:
  riak_kv-2.2.5:
    name: "Upgrading to 2.2.5"
    identifier: "upgrading_version"
    weight: 101
    parent: "upgrading"
toc: true
aliases:
  - /riak-docs/riak/2.2.5/upgrade-v20/
  - /riak-docs/riak/kv/2.2.5/ops/upgrading/rolling-upgrades/
  - /riak-docs/riak/kv/2.2.5/ops/upgrading/rolling-upgrades/
  - /riak-docs/riak/kv/2.2.5/setup/upgrading/cluster/

---


[production checklist]: {{<baseurl>}}riak/kv/2.2.5/setup/upgrading/checklist
...
[release notes]: {{<baseurl>}}riak/kv/2.2.5/release-notes
...
[jmx monitor]: {{<baseurl>}}riak/kv/2.2.5/using/reference/jmx
[snmp]: {{<baseurl>}}riak/kv/2.2.5/using/reference/snmp
[Release Notes]: {{<baseurl>}}riak/kv/2.2.5/release-notes


## Overview

You can upgrade one node or your whole cluster to Riak KV 2.2.5 by following the instructions below.
...
{{% note %}}
You must have [Java version 7 or higher](http://www.oracle.com/technetwork/java/javase/downloads/index.html) in order to upgrade to Riak KV 2.2.5.
{{% /note %}}
...
{{% note %}}
You must have [Java version 7 or higher](http://www.oracle.com/technetwork/java/javase/downloads/index.html) in order to upgrade to Riak KV 2.2.5. If you do not have it installed, please install it now.
{{% /note %}}
