...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/ops/advanced/backends/leveldb/
  - /riak-docs/riak/kv/2.2.5/ops/advanced/backends/leveldb/
---
...
[config reference#aae]: {{<baseurl>}}riak/kv/2.2.5/configuring/reference/#active-anti-entropy
