...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/ops/advanced/backends/multi/
  - /riak-docs/riak/kv/2.2.5/ops/advanced/backends/multi/
---
...
[use admin riak-admin cli]: {{<baseurl>}}riak/kv/2.2.5/using/admin/riak-admin
