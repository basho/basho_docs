...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/theory/concepts/vnodes
  - /riak-docs/riak/kv/2.2.5/theory/concepts/vnodes
---


[concept causal context]: {{<baseurl>}}riak/kv/2.2.5/learn/concepts/causal-context
[concept clusters ring]: {{<baseurl>}}riak/kv/2.2.5/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}riak/kv/2.2.5/setup/planning/backend/bitcask) as a backend, navigate
