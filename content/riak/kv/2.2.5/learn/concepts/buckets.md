...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/theory/concepts/Buckets
  - /riak-docs/riak/kv/2.2.5/theory/concepts/Buckets
  - /riak-docs/riak/2.2.5/theory/concepts/buckets
  - /riak-docs/riak/kv/2.2.5/theory/concepts/buckets
---

[apps cluster metadata]: {{<baseurl>}}riak/kv/2.2.5/developing/app-guide/cluster-metadata
