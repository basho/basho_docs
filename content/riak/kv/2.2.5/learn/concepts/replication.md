...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/theory/concepts/Replication
  - /riak-docs/riak/kv/2.2.5/theory/concepts/Replication
  - /riak-docs/riak/2.2.5/theory/concepts/replication
  - /riak-docs/riak/kv/2.2.5/theory/concepts/replication
---
...
[concept causal context vc]: {{<baseurl>}}riak/kv/2.2.5/learn/concepts/causal-context/#vector-clocks
...
[glossary ring]: {{<baseurl>}}riak/kv/2.2.5/learn/glossary/#ring
...
bucket's [bucket type]({{<baseurl>}}riak/kv/2.2.5/developing/usage/bucket-types).
...
[Multi-Datacenter Replications]({{<baseurl>}}riak/kv/2.2.5/setup/planning/backend/multi) capabilities.
...
type]({{<baseurl>}}riak/kv/2.2.5/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index]({{<baseurl>}}riak/kv/2.2.5/developing/usage/secondary-indexes/) and
[MapReduce]({{<baseurl>}}riak/kv/2.2.5/developing/usage/mapreduce/) queries. Lowering an object or bucket's
