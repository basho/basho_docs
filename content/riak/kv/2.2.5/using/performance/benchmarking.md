...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/ops/building/benchmarking
  - /riak-docs/riak/kv/2.2.5/ops/building/benchmarking
---
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}riak/kv/2.2.5/setup/installing/source/erlang) for instructions
