...
aliases:
  - /riak-docs/riak/2.2.5/ops/mdc/v3/operations
  - /riak-docs/riak/kv/2.2.5/ops/mdc/v3/operations
---
...
[ref v3 stats]: {{<baseurl>}}riak/kv/2.2.5/using/reference/multi-datacenter/statistics
