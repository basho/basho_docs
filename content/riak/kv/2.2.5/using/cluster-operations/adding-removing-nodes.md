...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/ops/running/nodes/adding-removing
  - /riak-docs/riak/kv/2.2.5/ops/running/nodes/adding-removing
---
...
simply the script [`riak`]({{<baseurl>}}riak/kv/2.2.5/using/admin/riak-cli/):
