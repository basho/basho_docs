...
[upgrade]: {{<baseurl>}}riak/kv/2.2.5/setup/upgrading/cluster/
[rolling restarts]: {{<baseurl>}}riak/kv/2.2.5/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}riak/kv/2.2.5/using/cluster-operations/adding-removing-nodes
