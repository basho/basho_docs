...
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}riak/kv/2.2.5/using/reference/v3-multi-datacenter/) instead.
{{% /note %}}
