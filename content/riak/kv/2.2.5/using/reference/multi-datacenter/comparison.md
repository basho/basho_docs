...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/ops/mdc/comparison
  - /riak-docs/riak/kv/2.2.5/ops/mdc/comparison
---

This document is a systematic comparison of [Version 2]({{<baseurl>}}riak/kv/2.2.5/using/reference/v2-multi-datacenter) and [Version 3]({{<baseurl>}}riak/kv/2.2.5/using/reference/v3-multi-datacenter) of Riak Enterprise's Multi-Datacenter
...
* Version 3 is able to take advantage of [Active Anti-Entropy]({{<baseurl>}}riak/kv/2.2.5/learn/concepts/active-anti-entropy/) \(AAE)
