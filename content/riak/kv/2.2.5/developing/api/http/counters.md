...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/dev/references/http/counters
  - /riak-docs/riak/kv/2.2.5/dev/references/http/counters
---
...
The regular POST/PUT ([HTTP Store Object]({{<baseurl>}}riak/kv/2.2.5/developing/api/http/store-object)) and GET ([HTTP Fetch Object]({{<baseurl>}}riak/kv/2.2.5/developing/api/http/fetch-object)) responses apply here.
