...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/dev/references/http/set-bucket-props
  - /riak-docs/riak/kv/2.2.5/dev/references/http/set-bucket-props
---
...
clock) when writing
* `precommit` - [precommit hooks]({{<baseurl>}}riak/kv/2.2.5/developing/usage/commit-hooks)
* `postcommit` - [postcommit hooks]({{<baseurl>}}riak/kv/2.2.5/developing/usage/commit-hooks)
