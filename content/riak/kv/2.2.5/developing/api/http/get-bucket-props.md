...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/dev/references/http/get-bucket-props
  - /riak-docs/riak/kv/2.2.5/dev/references/http/get-bucket-props
---
...
default). See also [HTTP List Keys]({{<baseurl>}}riak/kv/2.2.5/developing/api/http/list-keys).
...
See [HTTP Set Bucket Properties]({{<baseurl>}}riak/kv/2.2.5/developing/api/http/set-bucket-props) for more information about the available
