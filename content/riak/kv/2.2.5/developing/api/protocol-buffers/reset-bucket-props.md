...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/dev/references/protocol-buffers/reset-bucket-props
  - /riak-docs/riak/kv/2.2.5/dev/references/protocol-buffers/reset-bucket-props
---
...
[bucket type]({{<baseurl>}}riak/kv/2.2.5/developing/usage/bucket-types) using the `type` value. If you do not
