...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/dev/references/protocol-buffers/delete-object
  - /riak-docs/riak/kv/2.2.5/dev/references/protocol-buffers/delete-object
---

Delete an object in the specified [bucket type]({{<baseurl>}}riak/kv/2.2.5/using/cluster-operations/bucket-types)/bucket/key location.
