...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/dev/advanced/mapreduce/
  - /riak-docs/riak/kv/2.2.5/dev/advanced/mapreduce/
---
...
[`set-union`] function. In that case, the first set of inputs might be `[1,2.2.5]`,
...
[installing custom code]({{<baseurl>}}riak/kv/2.2.5/using/reference/custom-code).
{{% /note %}}
