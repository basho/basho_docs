...
version_history:
  in: "2.1.0+"
aliases:
  - /riak-docs/riak/2.2.5/dev/advanced/write-once
  - /riak-docs/riak/kv/2.2.5/dev/advanced/write-once
---
...
[strong consistency]: {{<baseurl>}}riak/kv/2.2.5/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}riak/kv/2.2.5/setup/planning/backend/multi) backend does not
