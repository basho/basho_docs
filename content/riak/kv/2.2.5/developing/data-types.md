...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/dev/using/data-types
  - /riak-docs/riak/kv/2.2.5/dev/using/data-types
  - /riak-docs/riak/2.2.5/dev/data-modeling/data-types
  - /riak-docs/riak/kv/2.2.5/dev/data-modeling/data-types
---
