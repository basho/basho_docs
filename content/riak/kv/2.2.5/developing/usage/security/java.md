...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/dev/advanced/client-security/java
  - /riak-docs/riak/kv/2.2.5/dev/advanced/client-security/java
---
...
security setup described [below](#java-client-basics). [Certificate]({{<baseurl>}}riak/kv/2.2.5/using/security/managing-sources/#certificate-based-authentication)-based authentication is not
