...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/dev/using/conflict-resolution/ruby
  - /riak-docs/riak/kv/2.2.5/dev/using/conflict-resolution/ruby
---
...
the official Ruby client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/2.2.5/developing/usage) section.
