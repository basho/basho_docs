...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/dev/using/conflict-resolution/php
  - /riak-docs/riak/kv/2.2.5/dev/using/conflict-resolution/php
---
...
the official PHP client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/2.2.5/developing/usage) section.
