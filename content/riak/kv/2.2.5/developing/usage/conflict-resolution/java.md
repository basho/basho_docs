...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/dev/using/conflict-resolution/java
  - /riak-docs/riak/kv/2.2.5/dev/using/conflict-resolution/java
---
...
[bucket type]({{<baseurl>}}riak/kv/2.2.5/developing/usage/bucket-types) `siblings`, and for this bucket type
...
the official Java client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/2.2.5/developing/usage) section.
