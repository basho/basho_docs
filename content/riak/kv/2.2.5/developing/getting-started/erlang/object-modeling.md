...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/dev/taste-of-riak/object-modeling-erlang
  - /riak-docs/riak/kv/2.2.5/dev/taste-of-riak/object-modeling-erlang
---
...
We'll be using the bucket `Users` to store our data. We won't be [using bucket types]({{<baseurl>}}riak/kv/2.2.5/developing/usage/bucket-types) here, so we don't need to specify one.
