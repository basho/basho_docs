...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/dev/taste-of-riak/golang
  - /riak-docs/riak/kv/2.2.5/dev/taste-of-riak/golang
---

If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}riak/kv/2.2.5/using/running-a-cluster) first and ensure you have
...
[CRUD Operations]({{<baseurl>}}riak/kv/2.2.5/developing/getting-started/golang/crud-operations)
