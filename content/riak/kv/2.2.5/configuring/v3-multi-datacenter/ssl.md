...
aliases:
  - /riak-docs/riak/2.2.5/ops/mdc/v3/ssl
  - /riak-docs/riak/kv/2.2.5/ops/mdc/v3/ssl
---

[config reference#advanced.config]: {{<baseurl>}}riak/kv/2.2.5/configuring/reference/#the-advanced-config-file
