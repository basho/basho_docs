...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/ops/advanced/configs/mapreduce/
  - /riak-docs/riak/kv/2.2.5/ops/advanced/configs/mapreduce/
---

[usage mapreduce]: {{<baseurl>}}riak/kv/2.2.5/developing/usage/mapreduce
[config reference#appconfig]: {{<baseurl>}}riak/kv/2.2.5/configuring/reference/#app-config
