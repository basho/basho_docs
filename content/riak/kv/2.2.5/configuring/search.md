...
toc: true
aliases:
  - /riak-docs/riak/2.2.5/ops/advanced/configs/search/
  - /riak-docs/riak/kv/2.2.5/ops/advanced/configs/search/
---
...
[cluster-ops aae throttle]: {{<baseurl>}}riak/kv/2.2.5/using/cluster-operations/active-anti-entropy/#throttling
[config reference]: {{<baseurl>}}riak/kv/2.2.5/configuring/reference
[config reference#search]: {{<baseurl>}}riak/kv/2.2.5/configuring/reference/#search
