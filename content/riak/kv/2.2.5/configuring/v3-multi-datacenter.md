...
aliases:
  - /riak-docs/riak/2.2.5/ops/mdc/v3/configuration
  - /riak-docs/riak/kv/2.2.5/ops/mdc/v3/configuration
---

[config reference#advanced]: {{<baseurl>}}riak/kv/2.2.5/configuring/reference/#advanced-configuration
[config v3 ssl#verify-peer]: {{<baseurl>}}riak/kv/2.2.5/configuring/v3-multi-datacenter/ssl/#verifying-peer-certificates
