...
version_history:
  in: "2.1.0+"
aliases:
  - /riak/2.9.0p5/dev/advanced/write-once
  - /riak/kv/2.9.0p5/dev/advanced/write-once
  - /riak/2.9.0p5/developing/app-guide/write-once/
  - /riak/2.9.0/developing/app-guide/write-once/
  - /riak/kv/2.9.0/developing/app-guide/write-once/
  - /riak/kv/2.9.0p1/developing/app-guide/write-once/
  - /riak/kv/2.9.0p2/developing/app-guide/write-once/
  - /riak/kv/2.9.0p3/developing/app-guide/write-once/
...
[strong consistency]: {{<baseurl>}}riak/kv/2.9.0p5/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}riak/kv/2.9.0p5/setup/planning/backend/multi) backend does not
