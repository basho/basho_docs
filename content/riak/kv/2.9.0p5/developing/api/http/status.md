...
toc: true
aliases:
  - /riak/2.9.0p5/dev/references/http/status
  - /riak/kv/2.9.0p5/dev/references/http/status
  - /riak/2.9.0p5/developing/api/http/status/
  - /riak/2.9.0/developing/api/http/status/
  - /riak/kv/2.9.0/developing/api/http/status/
  - /riak/kv/2.9.0p1/developing/api/http/status/
  - /riak/kv/2.9.0p2/developing/api/http/status/
  - /riak/kv/2.9.0p3/developing/api/http/status/
  - /riak/kv/2.9.0p4/developing/api/http/status/
---
...
The output of `/stats` contains the output of `riak-admin status` detailed in the [Inspecting a Node]({{<baseurl>}}riak/kv/2.9.0p5/using/cluster-operations/inspecting-node) doc, plus the below stats generated by the Riak Core application.
