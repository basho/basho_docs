...
toc: true
aliases:
  - /riak/2.9.0p5/dev/taste-of-riak/golang
  - /riak/kv/2.9.0p5/dev/taste-of-riak/golang
  - /riak/2.9.0p5/developing/getting-started/golang/
  - /riak/2.9.0/developing/getting-started/golang/
  - /riak/kv/2.9.0/developing/getting-started/golang/
...
[CRUD Operations]({{<baseurl>}}riak/kv/2.9.0p5/developing/getting-started/golang/crud-operations)
