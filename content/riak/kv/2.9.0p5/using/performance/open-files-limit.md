...
aliases:
  ...
  - /riak/kv/2.9.0/using/performance/open-files-limit/
  - /riak/kv/2.9.0p1/using/performance/open-files-limit/
  - /riak/kv/2.9.0p2/using/performance/open-files-limit/
  - /riak/kv/2.9.0p3/using/performance/open-files-limit/
