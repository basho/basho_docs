...
[upgrade]: /riak/kv/2.0.9/setup/upgrading/cluster/
[rolling restarts]: /riak/kv/2.0.9/using/repair-recovery/rolling-restart/
[add node]: /riak/kv/2.0.9/using/cluster-operations/adding-removing-nodes
