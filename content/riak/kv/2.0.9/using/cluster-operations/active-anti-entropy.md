...
toc: true
aliases:
  - /riak/kv/2.0.9/ops/advanced/aae/
  - /riak/2.0.9/ops/advanced/aae/
---

[config search#throttledelay]: {{<baseurl>}}riak/kv/2.0.9/configuring/search/#search-anti-entropy-throttle-tier-delay
[config search#throttle]: {{<baseurl>}}riak/kv/2.0.9/configuring/search/#search-anti-entropy-throttle
