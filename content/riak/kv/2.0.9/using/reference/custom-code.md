...
[pre/post-commit hooks](/riak/kv/2.0.9/developing/usage/commit-hooks), and MapReduce operations. This
doc contains installation steps with simple examples for each use case.

Your developers can compile [custom erlang code](/riak/kv/2.0.9/developing/usage/commit-hooks), which
...
in the [Commands documentation](/riak/kv/2.0.9/using/admin/riak-admin/#wait-for-service).
