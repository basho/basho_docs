...
[concept replication aae]: {{<baseurl>}}riak/kv/2.0.9/learn/concepts/replication/#active-anti-entropy
...
[learn dynamo]: {{<baseurl>}}riak/kv/2.0.9/learn/dynamo
[plan cluster capacity]: {{<baseurl>}}riak/kv/2.0.9/setup/planning/cluster-capacity
[repair recover failure recovery]: {{<baseurl>}}riak/kv/2.0.9/using/repair-recovery/failure-recovery
[repair recover repairs]: {{<baseurl>}}riak/kv/2.0.9/using/repair-recovery/repairs
...
* [Bucket Types]({{<baseurl>}}riak/kv/2.0.9/developing/usage/bucket-types)
