...
aliases:
  ...
  - /riak/kv/2.0.9/theory/concepts/vnodes
---


[concept causal context]: {{<baseurl>}}riak/kv/2.0.9/learn/concepts/causal-context
[concept clusters ring]: {{<baseurl>}}riak/kv/2.0.9/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}riak/kv/2.0.9/setup/planning/backend/bitcask) as a backend, navigate
