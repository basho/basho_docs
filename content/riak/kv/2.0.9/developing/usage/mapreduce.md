...
aliases:
  ...
  - /riak/kv/2.0.9/dev/using/mapreduce
---
...
[usage types]: {{<baseurl>}}riak/kv/2.0.9/developing/usage/bucket-types
[api http]: {{<baseurl>}}riak/kv/2.0.9/developing/api/http
[api pb]: {{<baseurl>}}riak/kv/2.0.9/developing/api/protocol-buffers
[glossary vnode]: {{<baseurl>}}riak/kv/2.0.9/learn/glossary/#vnode
[guide mapreduce]: {{<baseurl>}}riak/kv/2.0.9/developing/app-guide/advanced-mapreduce
