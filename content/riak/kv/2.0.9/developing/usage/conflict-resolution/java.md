...
aliases:
  ...
  - /riak/kv/2.0.9/dev/using/conflict-resolution/java
---
...
[bucket type]({{<baseurl>}}riak/kv/2.0.9/developing/usage/bucket-types) `siblings`, and for this bucket type
...
the official Java client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/2.0.9/developing/usage) section.
