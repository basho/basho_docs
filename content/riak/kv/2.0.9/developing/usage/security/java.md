...
aliases:
  ...
  - /riak/kv/2.0.9/dev/advanced/client-security/java
---
...
security setup described [below](#java-client-basics). [Certificate]({{<baseurl>}}riak/kv/2.0.9/using/security/managing-sources/#certificate-based-authentication)-based authentication is not
