...
aliases:
  ...
  - /riak/kv/2.0.9/dev/references/http/search-index-info
---

Retrieves information about all currently available [Search indexes]({{<baseurl>}}riak/kv/2.0.9/developing/usage/search) in JSON format.
