...
binary (as `name`). Optionally, you can specify a [`schema`](/riak/kv/2.0.9/developing/usage/search-schemas) name and/or an `n_val`, i.e. the number of nodes on which the
