...
aliases:
  ...
  - /riak/kv/2.0.9/dev/references/protocol-buffers/set-bucket-props
---
...
[PBC Get Bucket Properties]({{<baseurl>}}riak/kv/2.0.9/developing/api/protocol-buffers/get-bucket-props) documentation.

You can also specify a [bucket type]({{<baseurl>}}riak/kv/2.0.9/developing/usage/bucket-types) using the
