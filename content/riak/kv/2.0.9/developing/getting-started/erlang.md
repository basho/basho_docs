...
If you haven't set up a Riak Node and started it, please visit [Running A Cluster](/riak/kv/2.0.9/using/running-a-cluster) first.
...
[CRUD Operations](/riak/kv/2.0.9/developing/getting-started/erlang/crud-operations)
