...
aliases:
  ...
  - /riak/kv/2.9.4/ops/advanced/configs/search/
---
...
[cluster-ops aae throttle]: {{<baseurl>}}riak/kv/2.9.4/using/cluster-operations/active-anti-entropy/#throttling
[config reference]: {{<baseurl>}}riak/kv/2.9.4/configuring/reference
[config reference#search]: {{<baseurl>}}riak/kv/2.9.4/configuring/reference/#search
