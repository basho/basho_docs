...
aliases:
  ...
  - /riak/kv/2.9.4/dev/taste-of-riak/csharp
---



If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}riak/kv/2.9.4/using/running-a-cluster) first.
...
[CRUD Operations]({{<baseurl>}}riak/kv/2.9.4/developing/getting-started/csharp/crud-operations)
