...
aliases:
  ...
  - /riak/kv/2.9.4/dev/references/protocol-buffers/yz-schema-get
---

Fetch a [search schema]({{<baseurl>}}riak/kv/2.9.4/developing/usage/search-schemas) from Riak Search.
