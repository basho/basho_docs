...
aliases:
  ...
  - /riak/kv/2.9.4/dev/references/http/search-index-info
---

Retrieves information about all currently available [Search indexes]({{<baseurl>}}riak/kv/2.9.4/developing/usage/search) in JSON format.
