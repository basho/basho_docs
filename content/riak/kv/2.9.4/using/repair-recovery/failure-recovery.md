...
aliases:
  ...
  - /riak/kv/2.9.4/ops/running/recovery/failure-recovery
---
...
returns to service (also called [hinted handoff]({{<baseurl>}}riak/kv/2.9.4/learn/glossary/#hinted-handoff)).
