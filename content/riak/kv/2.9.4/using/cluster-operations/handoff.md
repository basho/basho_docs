...
aliases:
  ...
  - /riak/kv/2.9.4/ops/running/handoff
---
...
[`riak-admin`]({{<baseurl>}}riak/kv/2.9.4/using/admin/riak-admin/) interface enables you to
...
This command displays the values for handoff-specific [configurable parameters]({{<baseurl>}}riak/kv/2.9.4/configuring/reference/#intra-cluster-handoff) on each node in
