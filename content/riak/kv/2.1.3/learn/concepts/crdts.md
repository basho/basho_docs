...
aliases:
  ...
  - /riak/kv/2.1.3/theory/concepts/crdts
---


[concept causal context dvv]: {{<baseurl>}}riak/kv/2.1.3/learn/concepts/causal-context/#dotted-version-vectors
[concept causal context sib]: {{<baseurl>}}riak/kv/2.1.3/learn/concepts/causal-context/#siblings
...
[concept strong consistency]: {{<baseurl>}}riak/kv/2.1.3/learn/concepts/strong-consistency
...
indexes]({{<baseurl>}}riak/kv/2.1.3/developing/usage/secondary-indexes/) and [Search]({{<baseurl>}}riak/kv/2.1.3/developing/usage/search/).
...
object]({{<baseurl>}}riak/kv/2.1.3/developing/data-types/#Data-Types-and-Context) that is similar to a
