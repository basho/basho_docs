...
Riak: [flags](/riak/kv/2.1.3/developing/data-types/maps#flags), [registers](/riak/kv/2.1.3/developing/data-types/maps#registers),
...
* [Strong Consistency](/riak/kv/2.1.3/using/reference/strong-consistency) provides a theoretical treatment of how a
...
* [Configuration Files](/riak/kv/2.1.3/configuring/reference/) lists and describes all of the configurable
