...
[strong consistency]: {{<baseurl>}}riak/kv/2.1.3/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}riak/kv/2.1.3/setup/planning/backend/multi) backend does not
