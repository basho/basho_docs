...
aliases:
  ...
  - /riak/kv/2.1.3/dev/using/data-modeling
...
* [User Settings and Preferences](/riak/kv/2.1.3/developing/data-modeling/#user-settings-and-preferences)
* [User Events and Timelines](/riak/kv/2.1.3/developing/data-modeling/#user-events-and-timelines)
* [Articles, Blog Posts, and Other Content](/riak/kv/2.1.3/developing/data-modeling/#articles-blog-posts-and-other-content)
...
address), [using secondary indexes](/riak/kv/2.1.3/developing/usage/secondary-indexes/) can provide an easy solution.
...
for analysis [using MapReduce](/riak/kv/2.1.3/developing/usage/mapreduce) or as a storage system used in
