...
aliases:
  ...
  - /riak/kv/2.1.3/community/faqs/developing
---
...
[Bucket Properties]: {{<baseurl>}}riak/kv/2.1.3/developing/usage
[built-in functions list]: https://github.com/basho/riak_kv/blob/master/priv/mapred_builtins.js
[commit hooks]: {{<baseurl>}}riak/kv/2.1.3/developing/usage/commit-hooks
...
[Erlang Riak Client]: {{<baseurl>}}riak/kv/2.1.3/developing/client-libraries
...
[System Planning]: {{<baseurl>}}riak/kv/2.1.3/setup/planning/start/#network-configuration-load-balancing
[vector clocks]: {{<baseurl>}}riak/kv/2.1.3/learn/concepts/causal-context#vector-clocks
