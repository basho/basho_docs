...
aliases:
  ...
  - /riak/kv/2.1.3/dev/references/protocol-buffers/dt-union
---
...
`DtOp` messages are sent only as part of a [`DtUpdateReq`]({{<baseurl>}}riak/kv/2.1.3/developing/api/protocol-buffers/dt-store) message.
