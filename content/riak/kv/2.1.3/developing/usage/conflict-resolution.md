...
One of Riak's [central goals](../../../learn/why-riak-kv) is high availability. It was built as a [clustered](/riak/kv/2.1.3/learn/concepts/clusters) system in which any [node](/riak/kv/2.1.3/learn/glossary/#node) is capable of receiving requests without requiring that
...
[sibling explosion](/riak/kv/2.1.3/using/performance/latency-reduction#siblings), which can
...
the entire node. Other issues include [increased cluster latency](/riak/kv/2.1.3/using/performance/latency-reduction) as the object is replicated and out-of-memory errors.
