...
[Source Install]: /riak/kv/2.1.3/installing/source
[Source Install Erlang]: /riak/kv/2.1.3/installing/source/erlang
[Install Verify]: /riak/kv/2.1.3/installing/verify

Riak KV can be installed on CentOS- or Red-Hat-based systems using a binary
package or by [compiling Riak from source code][Source Install]. The following steps have been tested to work with Riak on
...
Instructions can be found in [Installing Erlang][Source Install Erlang].
