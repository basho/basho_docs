...
[Install Riak KV from Source]: /riak/kv/2.1.3/installing/source/
[Riak KV Security]: /riak/kv/2.1.3/using/managing/security/
[Install Erlang]: /riak/kv/2.1.3/installing/source/erlang
[Install Verify]: /riak/kv/2.1.3/installing/verify

Riak KV can be installed on Debian or Ubuntu-based systems using a binary
package or by [compiling from source code][Install Riak KV from Source].
...
associated with [Riak security][Riak KV Security].
...
Instructions can be found in [Installing Erlang][Install Erlang].
