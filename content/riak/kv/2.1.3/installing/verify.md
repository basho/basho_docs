...
(<tt>/home/riak/rel/riak/bin</tt>) to your <tt>PATH</tt> so that Riak KV commands can be used in the same manner as with a packaged installation.
</div>
...
You can read more about why in the [Open Files Limit][Open Files Limit] documentation.
</div>
...
More extensive documentation for Riaknostic can be found in the [Inspecting a Node][Inspect a Node] guide.
...
* [Client Libraries][Riak KV Client Libraries] to use Riak with your favorite programming language
