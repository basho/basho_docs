...
[production checklist]: /riak/kv/2.1.3/setup/upgrading/checklist
...
[jmx monitor]: /riak/kv/2.1.3/using/reference/jmx
[snmp]: /riak/kv/2.1.3/using/reference/snmp
...
If you run [Riak Control](/riak/kv/2.1.3/using/admin/riak-control), you should disable it during the rolling upgrade process.
{{% /note %}}
