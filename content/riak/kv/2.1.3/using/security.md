...
[config reference search]: {{<baseurl>}}riak/kv/2.1.3/configuring/reference/#search
[config search enabling]: {{<baseurl>}}riak/kv/2.1.3/configuring/search/#enabling-riak-search
