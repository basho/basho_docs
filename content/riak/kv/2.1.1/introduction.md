...
* **Configuration management** --- Riak's [configuration files](/riak/kv/2.1.1/configuring/reference/) have
...
More on upgrading can be found in our [Riak 2.0 upgrade guide](/riak/kv/2.1.1/setup/upgrading/version).
...
Riak: [flags](/riak/kv/2.1.1/developing/data-types/maps#flags), [registers](/riak/kv/2.1.1/developing/data-types/maps#registers),
...
* [Using Data Types](/riak/kv/2.1.1/developing/data-types) explains how to use Riak Data Types on the
...
* [Data Types](/riak/kv/2.1.1/developing/data-types) explains some of the theoretical concerns that drive
...
* [Using Strong Consistency](/riak/kv/2.1.1/using/cluster-operations/strong-consistency) shows you how to enable Riak's strong
  consistency subsystem and to apply strong consistency guarantees to
  data stored in specified buckets.
* [Strong Consistency](/riak/kv/2.1.1/using/reference/strong-consistency) provides a theoretical treatment of how a
  strongly consistent system differs from an [eventually consistent](/riak/kv/2.1.1/learn/concepts/eventual-consistency) system, as well as details about how
  strong consistency is implemented in Riak.
* [Managing Strong Consistency](/riak/kv/2.1.1/configuring/strong-consistency) is a guide to strong consistency for
  Riak operators.
...
* [Authentication and Authorization](/riak/kv/2.1.1/using/security/basics) explains how Riak Security can be
...
* [Managing Security Sources](/riak/kv/2.1.1/using/security/managing-sources/) is an in-depth tutorial on how to
...
* [Configuration Files](/riak/kv/2.1.1/configuring/reference/) lists and describes all of the configurable
...
* [Using Bucket Types](/riak/kv/2.1.1/using/reference/bucket-types) explains how to create, modify, and activate
...
clocks but are more effective at containing [sibling explosion](/riak/kv/2.1.1/learn/concepts/causal-context/#sibling-explosion) and can reduce Riak cluster latency.
...
While Basho offered official [client libraries](/riak/kv/2.1.1/developing/client-libraries) for Java, Ruby,
