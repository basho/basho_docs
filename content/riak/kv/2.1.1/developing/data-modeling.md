...
toc: true
aliases:
  - /riak/2.1.1/dev/using/data-modeling
  - /riak/kv/2.1.1/dev/using/data-modeling
...
operations, use of Riak features including [Data Types](/riak/kv/2.1.1/developing/data-types/),
[MapReduce](/riak/kv/2.1.1/developing/usage/mapreduce/), [Search](/riak/kv/2.1.1/developing/usage/search/),
[secondary indexes (2i)](/riak/kv/2.1.1/developing/usage/secondary-indexes/) and more. This guide
...
session expiry. Riak's [MapReduce](/riak/kv/2.1.1/developing/usage/mapreduce/) system can also be
...
address), [using secondary indexes](/riak/kv/2.1.1/developing/usage/secondary-indexes/) can provide an easy solution.
...
for analysis [using MapReduce](/riak/kv/2.1.1/developing/usage/mapreduce) or as a storage system used in
...
[secondary index](/riak/kv/2.1.1/developing/usage/secondary-indexes/), which would allow you to
perform queries on specific time interval ranges or to perform
[MapReduce](/riak/kv/2.1.1/developing/usage/mapreduce/) queries against the indexes.
...
username as a [secondary index](/riak/kv/2.1.1/developing/usage/secondary-indexes/) for efficient
lookup.
