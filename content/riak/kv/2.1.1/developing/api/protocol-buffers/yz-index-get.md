...
binary (as `name`). Optionally, you can specify a [`schema`](/riak/kv/2.1.1/developing/usage/search-schemas) name and/or an `n_val`, i.e. the number of nodes on which the
