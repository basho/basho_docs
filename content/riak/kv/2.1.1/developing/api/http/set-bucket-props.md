...
canonical_link: "docs.basho.com/riak/kv/latest/developing/api/http/set-bucket-props.md"
---
...
clock) when writing
* `precommit` - [precommit hooks](/riak/kv/2.1.1/developing/usage/commit-hooks)
* `postcommit` - [postcommit hooks](/riak/kv/2.1.1/developing/usage/commit-hooks)
