...
aliases:
  ...
  - /riak/kv/2.1.1/ops/building/installing/Installing-on-AWS-Marketplace
...
We also recommend that you read more about Riak's [Security and Firewalls]({{<baseurl>}}riak/kv/2.1.1/using/security/).
