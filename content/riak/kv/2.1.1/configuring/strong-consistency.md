...
[config reference#strong-cons]: /riak/kv/2.1.1/configuring/reference/#Strong-Consistency
...
[use admin riak-admin#ensemble]: /riak/kv/2.1.1/using/admin/riak-admin/#riak-admin-ensemble-status
