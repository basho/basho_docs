...
canonical_link: "docs.basho.com/riak/kv/latest/using/admin/commands.md"
---

[use admin riak-admin#cluster]: /riak/kv/2.1.1/using/admin/riak-admin/#cluster
...
[use admin riak-admin#cluster-plan]: /riak/kv/2.1.1/using/admin/riak-admin/#cluster-plan
[use admin riak-admin#cluster-commit]: /riak/kv/2.1.1/using/admin/riak-admin/#cluster-commit
