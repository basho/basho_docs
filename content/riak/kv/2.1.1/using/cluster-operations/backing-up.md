...
[aae read repair]: /riak/kv/2.1.1/learn/concepts/active-anti-entropy/#read-repair-vs-active-anti-entropy
...
In previous versions of Riak KV, there was a [`riak-admin backup`](/riak/kv/2.1.1/using/admin/riak-admin/#backup) command commonly used for
...
{{% note %}}
For more information on the `riak-admin cluster` commands, refer to our documentation on [cluster administration](/riak/kv/2.1.1/using/admin/).
{{% /note %}}
