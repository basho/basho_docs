...
You can also find more information on to how customize your own [search schema](/riak/kv/2.1.1/developing/usage/search-schemas).
...
[Active Anti-Entropy](/riak/kv/2.1.1/learn/concepts/active-anti-entropy/) \(AAE) is the process of discovering and
...
information on analysis, see [Search Schema](/riak/kv/2.1.1/developing/usage/search-schemas).
