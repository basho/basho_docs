...
[pre/post-commit hooks](/riak/kv/2.0.0/developing/usage/commit-hooks), and MapReduce operations. This
doc contains installation steps with simple examples for each use case.

Your developers can compile [custom erlang code](/riak/kv/2.0.0/developing/usage/commit-hooks), which
