...
[config reference search]: {{<baseurl>}}riak/kv/2.0.0/configuring/reference/#search
[config search enabling]: {{<baseurl>}}riak/kv/2.0.0/configuring/search/#enabling-riak-search
