...
treatment of how CRDTs work in Riak, see our [Data Types](/riak/kv/2.0.0/developing/data-types/) doc.
...
[below](/riak/kv/2.0.0/developing/data-types/#maps).
...
In order to use Riak Data Types, you must first create a [bucket type](/riak/kv/2.0.0/developing/usage/bucket-types) that sets the `datatype` bucket parameter to
...
documentation we offer a [full tutorial](/riak/kv/2.0.0/developing/usage/searching-data-types) as well as a variety of
[examples](/riak/kv/2.0.0/developing/usage/search/#data-types-and-search-examples), including code
...
>
> If you are connecting to Riak using one of Basho's official [client libraries](/riak/kv/2.0.0/developing/client-libraries), you can find more information about getting started with your client in our [Developing with Riak KV: Getting Started](/riak/kv/2.0.0/developing/getting-started) section.
...
set, which provides our client access to the set's [causal context](/riak/kv/2.0.0/learn/concepts/causal-context).
...
[causal context](/riak/kv/2.0.0/learn/concepts/causal-context), which enables Riak to make intelligent decisions
...
Data Type contexts are similar to [causal context](/riak/kv/2.0.0/learn/concepts/causal-context) in that they are
