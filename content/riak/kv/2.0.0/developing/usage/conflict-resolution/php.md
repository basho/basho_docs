...
aliases:
  ...
  - /riak/kv/2.0.0/dev/using/conflict-resolution/php
---
...
the official PHP client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/2.0.0/developing/usage) section.
