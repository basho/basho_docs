...
aliases:
  ...
  - /riak/kv/2.0.0/dev/references/http/store-search-schema
canonical_link: "https://docs.basho.com/riak/kv/latest/developing/api/http/store-search-schema"
---

Creates a new Riak [Search schema](/riak/kv/2.0.0/developing/usage/search-schemas).
...
formed XML schema. More information can be found in the [Search Schema](/riak/kv/2.0.0/developing/usage/search-schemas) document. If you've created a schema and stored it in the filed
