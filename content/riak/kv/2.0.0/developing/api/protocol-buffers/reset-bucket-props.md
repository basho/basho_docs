...
canonical_link: "docs.basho.com/riak/kv/latest/developing/api/protocol-buffers/reset-bucket-props.md"
---
...
[bucket type](/riak/kv/2.0.0/developing/usage/bucket-types) using the `type` value. If you do not
