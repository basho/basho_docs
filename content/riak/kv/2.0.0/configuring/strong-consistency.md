...
[config reference#strong-cons]: /riak/kv/2.0.0/configuring/reference/#strong-consistency
...
[use admin riak-admin#ensemble]: /riak/kv/2.0.0/using/admin/riak-admin/#riak-admin-ensemble-status
[use admin riak-admin]: /riak/kv/2.0.0/using/admin/riak-admin
[config reference#advanced]: /riak/kv/2.0.0/configuring/reference/#advanced-configuration
