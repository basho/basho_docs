...
aliases:
  ...
  - /riak/kv/3.0.13/ops/building/benchmarking
---
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}riak/kv/3.0.13/setup/installing/source/erlang) for instructions
