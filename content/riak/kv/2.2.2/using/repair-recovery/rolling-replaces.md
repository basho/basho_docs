...
[upgrade]: /riak/kv/2.2.2/setup/upgrading/cluster/
[rolling restarts]: /riak/kv/2.2.2/using/repair-recovery/rolling-restart/
[add node]: /riak/kv/2.2.2/using/cluster-operations/adding-removing-nodes
