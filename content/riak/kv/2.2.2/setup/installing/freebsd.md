...
aliases:
  ...
  - /riak/kv/2.2.2/ops/building/installing/Installing-on-FreeBSD
  - /riak/2.2.2/installing/freebsd/
  - /riak/kv/2.2.2/installing/freebsd/
---
...
```bash
sudo pkg_add -r http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.2.2/freebsd/9/riak-2.2.2-FreeBSD-amd64.tbz
```
