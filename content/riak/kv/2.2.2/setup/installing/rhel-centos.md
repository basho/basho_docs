...
* [el5](https://packagecloud.io/basho/riak/packages/el/5/riak-2.2.2-1.x86_64.rpm)
* [el6](https://packagecloud.io/basho/riak/packages/el/6/riak-2.2.2-1.el6.x86_64.rpm)
* [el7](https://packagecloud.io/basho/riak/packages/el/7/riak-2.2.2-1.el7.centos.x86_64.rpm)
* [Fedora 19](https://packagecloud.io/basho/riak/packages/fedora/19/riak-2.2.2-1.fc19.x86_64.rpm)
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.2.2/rhel/5/riak-2.2.2-1.el5.x86_64.rpm
sudo rpm -Uvh riak-2.2.2-1.el5.x86_64.rpm
```
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.2.2/rhel/6/riak-2.2.2-1.el6.x86_64.rpm
