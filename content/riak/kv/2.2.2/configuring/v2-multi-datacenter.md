...
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3](/riak/kv/2.2.2/configuring/v3-multi-datacenter/) instead.
{{% /note %}}
