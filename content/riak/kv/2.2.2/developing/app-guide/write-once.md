...
aliases:
  ...
  - /riak/kv/2.2.2/dev/advanced/write-once
---
...
[strong consistency]: {{<baseurl>}}riak/kv/2.2.2/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}riak/kv/2.2.2/setup/planning/backend/multi) backend does not
