...
aliases:
  ...
  - /riak/kv/2.2.2/dev/taste-of-riak/querying-erlang
---
...
A more comprehensive discussion can be found in [Key/Value Modeling]({{<baseurl>}}riak/kv/2.2.2/developing/key-value-modeling).
