...
aliases:
  ...
  - /riak/kv/2.2.2/dev/taste-of-riak/nodejs
---
...
If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}riak/kv/2.2.2/using/running-a-cluster) first.
...
[CRUD Operations]({{<baseurl>}}riak/kv/2.2.2/developing/getting-started/nodejs/crud-operations)
