...
aliases:
  ...
  - /riak/kv/2.2.2/dev/references/http/search-index-info
---

Retrieves information about all currently available [Search indexes]({{<baseurl>}}riak/kv/2.2.2/developing/usage/search) in JSON format.
