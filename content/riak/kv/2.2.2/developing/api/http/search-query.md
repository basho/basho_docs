...
Performs a [Riak KV Search](/riak/kv/2.2.2/developing/usage/search) query.
...
* `q` --- The actual Search query itself. Examples can be found in
    [Using Search](/riak/kv/2.2.2/developing/usage/search). If a query is not specified, Riak will return
