...
aliases:
  ...
  - /riak/kv/2.2.2/dev/references/protocol-buffers/yz-schema-get
---

Fetch a [search schema]({{<baseurl>}}riak/kv/2.2.2/developing/usage/search-schemas) from Riak Search.
