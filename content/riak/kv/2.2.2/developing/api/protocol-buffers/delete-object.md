...
aliases:
  ...
  - /riak/kv/2.2.2/dev/references/protocol-buffers/delete-object
---

Delete an object in the specified [bucket type]({{<baseurl>}}riak/kv/2.2.2/using/cluster-operations/bucket-types)/bucket/key location.
