...
application will be stored in buckets that bear the [bucket type](/riak/kv/2.2.2/developing/usage/bucket-types) `siblings`, and for this bucket type `allow_mult` is set
...
from the official Python client library, in the [Developing with Riak KV: Usage](/riak/kv/2.2.2/developing/usage) section.
