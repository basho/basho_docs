...
aliases:
  ...
  - /riak/kv/2.2.2/dev/using/conflict-resolution/golang
---

For reasons explained in the [Introduction to conflict resolution](/riak/kv/2.2.2/developing/usage/conflict-resolution), we strongly recommend adopting a conflict resolution strategy that
