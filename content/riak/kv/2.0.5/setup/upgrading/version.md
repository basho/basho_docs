...
If you use other new features, such as [Riak Security]({{<baseurl>}}riak/kv/2.0.5/using/security/basics) or the new [configuration files]({{<baseurl>}}riak/kv/2.0.5/configuring/reference/), you can still
