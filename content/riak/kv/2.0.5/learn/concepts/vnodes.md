...
aliases:
  ...
  - /riak/kv/2.0.5/theory/concepts/vnodes
---


[concept causal context]: {{<baseurl>}}riak/kv/2.0.5/learn/concepts/causal-context
[concept clusters ring]: {{<baseurl>}}riak/kv/2.0.5/learn/concepts/clusters/#the-ring
...
[perf strong consistency]: {{<baseurl>}}riak/kv/2.0.5/using/reference/strong-consistency
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}riak/kv/2.0.5/setup/planning/backend/bitcask) as a backend, navigate
