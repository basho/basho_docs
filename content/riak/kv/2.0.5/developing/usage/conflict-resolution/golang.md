...
aliases:
  ...
  - /riak/kv/2.0.5/dev/using/conflict-resolution/golang
canonical_link: "https://docs.basho.com/riak/kv/latest/developing/usage/conflict-resolution/golang"
---

For reasons explained in the [Introduction to conflict resolution](/riak/kv/2.0.5/developing/usage/conflict-resolution), we strongly recommend adopting a conflict resolution strategy that
