...
canonical_link: "docs.basho.com/riak/kv/latest/developing/usage/conflict-resolution/java.md"
---
...
[bucket type](/riak/kv/2.0.5/developing/usage/bucket-types) `siblings`, and for this bucket type
...
the official Java client library, in the [Developing with Riak KV: Usage](/riak/kv/2.0.5/developing/usage) section.
