...
canonical_link: "docs.basho.com/riak/kv/latest/developing/usage/conflict-resolution/ruby.md"
---

For reasons explained in the [Introduction to conflict resolution](/riak/kv/2.0.5/developing/usage/conflict-resolution), we strongly recommend adopting a
...
application will be stored in buckets that bear the [bucket type](/riak/kv/2.0.5/developing/usage/bucket-types) `siblings`, and for this bucket type `allow_mult` is set
...
the official Ruby client library, in the [Developing with Riak KV: Usage](/riak/kv/2.0.5/developing/usage) section.
