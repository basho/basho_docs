...
aliases:
  ...
  - /riak/kv/2.0.5/dev/using/conflict-resolution/php
...
the official PHP client library, in the [Developing with Riak KV: Usage](/riak/kv/2.0.5/developing/usage) section.
