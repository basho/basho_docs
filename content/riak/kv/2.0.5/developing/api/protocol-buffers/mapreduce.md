...
The JSON encoding is the same as [REST API](/riak/kv/2.0.5/developing/usage/mapreduce/#rest) and
the external term format is the same as the [local Erlang API](/riak/kv/2.0.5/developing/app-guide/advanced-mapreduce/#erlang)
