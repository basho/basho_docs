...
aliases:
  ...
  - /riak/kv/2.0.5/dev/references/http/counters
...
The regular POST/PUT ([HTTP Store Object](/riak/kv/2.0.5/developing/api/http/store-object)) and GET ([HTTP Fetch Object](/riak/kv/2.0.5/developing/api/http/fetch-object)) responses apply here.
