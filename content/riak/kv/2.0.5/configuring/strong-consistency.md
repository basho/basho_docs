...
[config reference#strong-cons]: {{<baseurl>}}riak/kv/2.0.5/configuring/reference/#strong-consistency
...
[use admin riak-admin#ensemble]: {{<baseurl>}}riak/kv/2.0.5/using/admin/riak-admin/#ensemble-status
[use admin riak-admin]: {{<baseurl>}}riak/kv/2.0.5/using/admin/riak-admin
[config reference#advanced]: {{<baseurl>}}riak/kv/2.0.5/configuring/reference/#advanced-configuration
