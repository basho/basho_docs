...
[upgrade]: /riak/kv/2.1.4/setup/upgrading/cluster/
[rolling restarts]: /riak/kv/2.1.4/using/repair-recovery/rolling-restart/
[add node]: /riak/kv/2.1.4/using/cluster-operations/adding-removing-nodes
