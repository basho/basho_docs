...
toc: true
aliases:
  - /riak/2.5.0/ops/upgrading/rolling-downgrades/
  - /riak/kv/2.5.0/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: /riak/kv/2.5.0/setup/upgrading/cluster
[config ref]: /riak/kv/2.5.0/configuring/reference
[concept aae]: /riak/kv/2.5.0/learn/concepts/active-anti-entropy/
[aae status]: /riak/kv/2.5.0/using/admin/riak-admin/#aae-status
...
If you enabled LZ4 compression in LevelDB and/or enabled global expiration in LevelDB when you installed KV 2.5.0, you cannot downgrade.
