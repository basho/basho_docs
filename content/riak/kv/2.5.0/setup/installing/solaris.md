...
```bash
curl -o /tmp/BASHOriak-2.5.0-Solaris10-i386.pkg.gz http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.5.0/solaris/10/BASHOriak-2.5.0-Solaris10-x86_64.pkg.gz
```
