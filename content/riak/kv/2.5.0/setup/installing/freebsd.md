...
toc: true
aliases:
  - /riak/2.5.0/ops/building/installing/Installing-on-FreeBSD
  - /riak/kv/2.5.0/ops/building/installing/Installing-on-FreeBSD
  - /riak/2.5.0/installing/freebsd/
  - /riak/kv/2.5.0/installing/freebsd/
---
...
`pkg_add` remote option. For this example, we're installing `riak-2.5.0-FreeBSD-amd64.tbz`.

```bash
sudo pkg_add -r http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.5.0/freebsd/9/riak-2.5.0-FreeBSD-amd64.tbz
```
...
```
Package dependency openssl-1.0.0_7 for /tmp/riak-2.5.0-FreeBSD-amd64.tbz not found!
```
