...
toc: true
aliases:
  - /riak/2.5.0/ops/building/installing/Installing-on-SmartOS
  - /riak/kv/2.5.0/ops/building/installing/Installing-on-SmartOS
  - /riak/2.5.0/installing/smartos/
  - /riak/kv/2.5.0/installing/smartos/
---

[install verify]: /riak/kv/2.5.0/setup/installing/verify

{{% note title="SmartOS End of Life (EOL) for Riak KV 2.5.0" %}}
SmartOS is no longer supported in Riak KV 2.5.0+. If you are interested in using Riak KV on SmartOS, you can still [build from source](../source).
{{% /note %}}
...
```
pkg_add /tmp/riak-2.5.0-SmartOS-x86_64.tgz
```
