...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.5/2.5.0/ubuntu/lucid/riak_2.5.0-1_amd64.deb
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.5/2.5.0/ubuntu/natty/riak_2.5.0-1_amd64.deb
sudo dpkg -i riak_2.5.0-1_amd64.deb
```
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.5/2.5.0/ubuntu/precise/riak_2.5.0-1_amd64.deb
sudo dpkg -i riak_2.5.0-1_amd64.deb
```
