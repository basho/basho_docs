...
toc: true
aliases:
  - /riak/2.5.0/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak/kv/2.5.0/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak/2.5.0/installing/amazon-web-services/
  - /riak/kv/2.5.0/installing/amazon-web-services/
---
...
We also recommend that you read more about Riak's [Security and Firewalls](/riak/kv/2.5.0/using/security/).
