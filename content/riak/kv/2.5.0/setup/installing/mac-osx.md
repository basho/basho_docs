...
toc: true
aliases:
  - /riak/2.5.0/ops/building/installing/Installing-on-Mac-OS-X
  - /riak/kv/2.5.0/ops/building/installing/Installing-on-Mac-OS-X
  - /riak/2.5.0/installing/mac-osx/
  - /riak/kv/2.5.0/installing/mac-osx/
---
...
```bash
curl -O http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.5.0/osx/10.8/riak-2.5.0-OSX-x86_64.tar.gz
tar xzvf riak-2.5.0-osx-x86_64.tar.gz
```
...
By default, this will place a `2.5.0` folder in
...
```bash
curl -O http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.5.0/riak-2.5.0.tar.gz
