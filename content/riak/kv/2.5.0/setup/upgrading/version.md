---
title: "Upgrading to Riak KV 2.5.0"
description: ""
project: "riak_kv"
project_version: "2.5.0"
menu:
  riak_kv-2.5.0:
    name: "Upgrading to 2.5.0"
    identifier: "upgrading_version"
    weight: 101
    parent: "upgrading"
toc: true
aliases:
  - /riak/2.5.0/upgrade-v20/
  - /riak/kv/2.5.0/ops/upgrading/rolling-upgrades/
  - /riak/kv/2.5.0/ops/upgrading/rolling-upgrades/
  - /riak/kv/2.5.0/setup/upgrading/cluster/

---


[production checklist]: /riak/kv/2.5.0/setup/upgrading/checklist
...
[release notes]: /riak/kv/2.5.0/release-notes
...
[jmx monitor]: /riak/kv/2.5.0/using/reference/jmx
[snmp]: /riak/kv/2.5.0/using/reference/snmp
[Release Notes]: /riak/kv/2.5.0/release-notes


## Overview

You can upgrade one node or your whole cluster to Riak KV 2.5.0 by following the instructions below.
...
{{% note %}}
You must have [Java version 7 or higher](http://www.oracle.com/technetwork/java/javase/downloads/index.html) in order to upgrade to Riak KV 2.5.0.
{{% /note %}}
...
{{% note %}}
You must have [Java version 7 or higher](http://www.oracle.com/technetwork/java/javase/downloads/index.html) in order to upgrade to Riak KV 2.5.0. If you do not have it installed, please install it now.
{{% /note %}}
