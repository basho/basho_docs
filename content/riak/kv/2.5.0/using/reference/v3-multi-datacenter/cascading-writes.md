...
aliases:
  - /riak/2.5.0/ops/mdc/v3/cascading-writes
  - /riak/kv/2.5.0/ops/mdc/v3/cascading-writes
---
...
`riak-repl` command. Please see the [Version 3 Operations guide](/riak/kv/2.5.0/using/cluster-operations/v3-multi-datacenter) for more information.
