...
toc: true
aliases:
  - /riak/2.5.0/ops/advanced/install-custom-code/
  - /riak/kv/2.5.0/ops/advanced/install-custom-code/
---

Riak supports the use of Erlang named functions in compiled modules for
[pre/post-commit hooks](/riak/kv/2.5.0/developing/usage/commit-hooks), and MapReduce operations. This
doc contains installation steps with simple examples for each use case.

Your developers can compile [custom erlang code](/riak/kv/2.5.0/developing/usage/commit-hooks), which
...
in the [Commands documentation](/riak/kv/2.5.0/using/admin/riak-admin/#wait-for-service).
