...
toc: true
aliases:
  - /riak/2.5.0/ops/running/stats-and-monitoring
  - /riak/kv/2.5.0/ops/running/stats-and-monitoring
---
...
are made available through the HTTP API via the [`/stats`](/riak/kv/2.5.0/developing/api/http/status) endpoint, or through the [`riak-admin`](/riak/kv/2.5.0/using/admin/riak-admin/) interface, in particular the `stat` and `status` commands.
...
Riak statistics provided in the [Inspecting a Node](/riak/kv/2.5.0/using/cluster-operations/inspecting-node) and [HTTP Status](/riak/kv/2.5.0/developing/api/http/status) documentation.
...
documentation on [system tuning](/riak/kv/2.5.0/using/performance/#storage-and-file-system-tuning).
...
If graphing all of the [available Riak metrics](/riak/kv/2.5.0/using/cluster-operations/inspecting-node) is
...
The [`riak-admin`](/riak/kv/2.5.0/using/admin/riak-admin/) tool provides two
...
[Inspecting a Node](/riak/kv/2.5.0/using/cluster-operations/inspecting-node/#riak-admin-status) document.
...
in the [Inspecting a Node](/riak/kv/2.5.0/using/cluster-operations/inspecting-node/#riak-admin-stat) document.
...
[Riak Control](/riak/kv/2.5.0/using/admin/riak-control/) is Basho's REST-driven user-interface for managing Riak
...
the Riak HTTP [`/stats`](/riak/kv/2.5.0/developing/api/http/status) endpoint is also available.
...
A [Riak New Relic Agent][riak_new_relic] for collecting statistics from the Riak HTTP [`/stats`](/riak/kv/2.5.0/developing/api/http/status) endpoint is also available.
...
[`/stats`](/riak/kv/2.5.0/developing/api/http/status) endpoint.
...
* [Inspecting a Node](/riak/kv/2.5.0/using/cluster-operations/inspecting-node)
* [Riaknostic](http://riaknostic.basho.com)
* [Riak Control](/riak/kv/2.5.0/using/admin/riak-control/)
