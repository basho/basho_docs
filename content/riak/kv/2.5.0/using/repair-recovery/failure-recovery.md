...
toc: true
aliases:
  - /riak/2.5.0/ops/running/recovery/failure-recovery
  - /riak/kv/2.5.0/ops/running/recovery/failure-recovery
---
...
returns to service (also called [hinted handoff](/riak/kv/2.5.0/learn/glossary/#hinted-handoff)).
