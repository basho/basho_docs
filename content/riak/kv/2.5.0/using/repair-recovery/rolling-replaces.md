...
[upgrade]: /riak/kv/2.5.0/setup/upgrading/cluster/
[rolling restarts]: /riak/kv/2.5.0/using/repair-recovery/rolling-restart/
[add node]: /riak/kv/2.5.0/using/cluster-operations/adding-removing-nodes
