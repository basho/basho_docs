...
toc: true
aliases:
  - /riak/2.5.0/ops/running/cluster-admin
  - /riak/kv/2.5.0/ops/running/cluster-admin
---

[use admin riak-admin#cluster]: /riak/kv/2.5.0/using/admin/riak-admin/#cluster
...
[use admin riak-admin#cluster-plan]: /riak/kv/2.5.0/using/admin/riak-admin/#cluster-plan
[use admin riak-admin#cluster-commit]: /riak/kv/2.5.0/using/admin/riak-admin/#cluster-commit
