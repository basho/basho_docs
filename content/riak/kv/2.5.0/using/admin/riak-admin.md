...
toc: true
aliases:
  - /riak/2.5.0/ops/running/tools/riak-admin
  - /riak/kv/2.5.0/ops/running/tools/riak-admin
---

[config reference]: /riak/kv/2.5.0/configuring/reference
[use admin commands]: /riak/kv/2.5.0/using/admin/commands
[use admin commands#join]: /riak/kv/2.5.0/using/admin/commands/#join
[use admin commands#leave]: /riak/kv/2.5.0/using/admin/commands/#leave
[cluster ops backup]: /riak/kv/2.5.0/using/cluster-operations/backing-up
[config reference#node-metadata]: /riak/kv/2.5.0/configuring/reference/#node-metadata
...
[config reference#ring]: /riak/kv/2.5.0/configuring/reference/#ring
...
[downgrade]: /riak/kv/2.5.0/setup/downgrade
...
[use admin riak-admin#stats]: /riak/kv/2.5.0/using/admin/riak-admin/#stats
