...
toc: true
aliases:
  - /riak/2.5.0/ops/building/benchmarking
  - /riak/kv/2.5.0/ops/building/benchmarking
---
...
* Erlang must be installed. See [Installing Erlang](/riak/kv/2.5.0/setup/installing/source/erlang) for instructions
