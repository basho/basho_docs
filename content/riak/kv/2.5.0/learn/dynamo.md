...
toc: false
aliases:
  - /riak/2.5.0/theory/dynamo
  - /riak/kv/2.5.0/theory/dynamo
---
...
[Consistent Hashing]: /riak/kv/2.5.0/learn/glossary/#consistent-hashing
[Gossip Protocol]: /riak/kv/2.5.0/learn/glossary/#gossiping
...
[Protocol Buffers API]: /riak/kv/2.5.0/developing/api/protocol-buffers/
...
[Further Reading on Partitioning in Riak KV]: /riak/kv/2.5.0/learn/concepts/clusters/
[All about the Riak KV Ring]: /riak/kv/2.5.0/learn/concepts/clusters/#the-ring
...
>
> [Vector Clock on Riak KV Glossary](/riak/kv/2.5.0/learn/glossary/#vector-clock)
>
...
>
>[REST API](/riak/kv/2.5.0/developing/api/http/)
>
>[Writing Data](/riak/kv/2.5.0/developing/usage/creating-objects/)
>
>[Reading Data](/riak/kv/2.5.0/developing/usage/reading-objects/)
...
> [Read Repair](/riak/kv/2.5.0/learn/concepts/replication/#read-repair).
...
[Hinted handoff]: /riak/kv/2.5.0/learn/glossary/#hinted-handoff
[Replication]: /riak/kv/2.5.0/developing/usage/replication/
...
[Multi Datacenter Replication]: /riak/kv/2.5.0/using/reference/v3-multi-datacenter/architecture/
...
[Adding and Removing Nodes]: /riak/kv/2.5.0/using/cluster-operations/adding-removing-nodes/
[Failure Scenarios]: /riak/kv/2.5.0/learn/concepts/eventual-consistency/
...
[riak-admin command-line tool]: /riak/kv/2.5.0/using/admin/riak-admin/
...
[gossiping]: /riak/kv/2.5.0/learn/glossary/#gossiping
...
[The Node Join Process]: /riak/kv/2.5.0/using/cluster-operations/adding-removing-nodes/#joining-nodes-to-form-a-cluster
...
[backend options]: /riak/kv/2.5.0/setup/planning/backend/
[Bitcask]: /riak/kv/2.5.0/setup/planning/backend/bitcask/
[LevelDB]: /riak/kv/2.5.0/setup/planning/backend/leveldb/
[Memory]: /riak/kv/2.5.0/setup/planning/backend/memory/
[secondary indexes]: /riak/kv/2.5.0/developing/usage/secondary-indexes/
...
[CRDTs]: /riak/kv/2.5.0/developing/data-types/
...
[partitioning]: /riak/kv/2.5.0/learn/concepts/replication/#understanding-replication-by-example
...
[The Node Join Process]: /riak/kv/2.5.0/using/cluster-operations/adding-removing-nodes/#joining-nodes-to-form-a-cluster
[Replacing a Node]: /riak/kv/2.5.0/using/cluster-operations/replacing-node/
...
[Load Balancing]: /riak/kv/2.5.0/configuring/load-balancing-proxy/
...
[client libraries]: /riak/kv/2.5.0/developing/client-libraries/
