...
toc: true
aliases:
  - /riak/2.5.0/dev/taste-of-riak/ruby
  - /riak/kv/2.5.0/dev/taste-of-riak/ruby
---



If you haven't set up a Riak Node and started it, please visit [Running A Cluster](/riak/kv/2.5.0/using/running-a-cluster) first. To try this flavor
...
[CRUD Operations](/riak/kv/2.5.0/developing/getting-started/ruby/crud-operations)
