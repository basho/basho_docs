...
toc: true
aliases:
  - /riak/2.5.0/dev/taste-of-riak/object-modeling-golang
  - /riak/kv/2.5.0/dev/taste-of-riak/object-modeling-golang
---
...
We'll be using the bucket `Users` to store our data. We won't be [using bucket types](/riak/kv/2.5.0/developing/usage/bucket-types) here, so we don't need to specify one.
