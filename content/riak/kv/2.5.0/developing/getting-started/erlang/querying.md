...
toc: true
aliases:
  - /riak/2.5.0/dev/taste-of-riak/querying-erlang
  - /riak/kv/2.5.0/dev/taste-of-riak/querying-erlang
---
...
A more comprehensive discussion can be found in [Key/Value Modeling](/riak/kv/2.5.0/developing/key-value-modeling).
