...
version_history:
  in: "2.1.0+"
aliases:
  - /riak/2.5.0/dev/advanced/write-once
  - /riak/kv/2.5.0/dev/advanced/write-once
---
...
[strong consistency]: /riak/kv/2.5.0/developing/app-guide/strong-consistency
...
The [Multi](/riak/kv/2.5.0/setup/planning/backend/multi) backend does not
