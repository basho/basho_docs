...
is Riak's [bucket types](/riak/kv/2.5.0/using/reference/bucket-types) feature. This feature
...
made both to memory and to disk. Logical clocks, namely [dotted version vectors](/riak/kv/2.5.0/learn/concepts/causal-context/#dotted-version-vectors), are used in place of [vector clocks](/riak/kv/2.5.0/learn/concepts/causal-context/#vector-clocks) or timestamps to resolve value conflicts. Values stored as cluster metadata are opaque Erlang
