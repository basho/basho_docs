...
toc: true
aliases:
  - /riak/2.5.0/dev/references/protocol-buffers/yz-schema-get
  - /riak/kv/2.5.0/dev/references/protocol-buffers/yz-schema-get
---

Fetch a [search schema](/riak/kv/2.5.0/developing/usage/search-schemas) from Riak Search.
