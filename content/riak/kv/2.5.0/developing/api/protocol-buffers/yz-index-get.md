...
toc: true
aliases:
  - /riak/2.5.0/dev/references/protocol-buffers/yz-index-get
  - /riak/kv/2.5.0/dev/references/protocol-buffers/yz-index-get
---
...
binary (as `name`). Optionally, you can specify a [`schema`](/riak/kv/2.5.0/developing/usage/search-schemas) name and/or an `n_val`, i.e. the number of nodes on which the
