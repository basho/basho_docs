...
toc: true
aliases:
  - /riak/2.5.0/dev/references/protocol-buffers/get-client-id
  - /riak/kv/2.5.0/dev/references/protocol-buffers/get-client-id
---
...
connected and can be changed using [Set Client ID](/riak/kv/2.5.0/developing/api/protocol-buffers/set-client-id).
