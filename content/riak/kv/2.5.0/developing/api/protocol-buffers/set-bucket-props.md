...
toc: true
aliases:
  - /riak/2.5.0/dev/references/protocol-buffers/set-bucket-props
  - /riak/kv/2.5.0/dev/references/protocol-buffers/set-bucket-props
---
...
[PBC Get Bucket Properties](/riak/kv/2.5.0/developing/api/protocol-buffers/get-bucket-props) documentation.

You can also specify a [bucket type](/riak/kv/2.5.0/developing/usage/bucket-types) using the
