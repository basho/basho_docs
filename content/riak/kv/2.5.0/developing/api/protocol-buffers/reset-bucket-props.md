...
toc: true
aliases:
  - /riak/2.5.0/dev/references/protocol-buffers/reset-bucket-props
  - /riak/kv/2.5.0/dev/references/protocol-buffers/reset-bucket-props
---
...
[bucket type](/riak/kv/2.5.0/developing/usage/bucket-types) using the `type` value. If you do not
