...
toc: true
aliases:
  - /riak/2.5.0/dev/references/protocol-buffers/delete-object
  - /riak/kv/2.5.0/dev/references/protocol-buffers/delete-object
---

Delete an object in the specified [bucket type](/riak/kv/2.5.0/using/cluster-operations/bucket-types)/bucket/key location.
