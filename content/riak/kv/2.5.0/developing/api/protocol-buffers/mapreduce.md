...
toc: true
aliases:
  - /riak/2.5.0/dev/references/protocol-buffers/mapreduce
  - /riak/kv/2.5.0/dev/references/protocol-buffers/mapreduce
---
...
The JSON encoding is the same as [REST API](/riak/kv/2.5.0/developing/usage/mapreduce/#rest) and
the external term format is the same as the [local Erlang API](/riak/kv/2.5.0/developing/app-guide/advanced-mapreduce/#erlang)
