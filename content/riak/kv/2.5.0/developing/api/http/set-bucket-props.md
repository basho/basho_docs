...
toc: true
aliases:
  - /riak/2.5.0/dev/references/http/set-bucket-props
  - /riak/kv/2.5.0/dev/references/http/set-bucket-props
---
...
clock) when writing
* `precommit` - [precommit hooks](/riak/kv/2.5.0/developing/usage/commit-hooks)
* `postcommit` - [postcommit hooks](/riak/kv/2.5.0/developing/usage/commit-hooks)
