...
toc: true
aliases:
  - /riak/2.5.0/dev/references/http/fetch-search-schema
  - /riak/kv/2.5.0/dev/references/http/fetch-search-schema
---

Retrieves a Riak KV [search schema](/riak/kv/2.5.0/developing/usage/search-schemas).
