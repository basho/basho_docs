...
toc: true
aliases:
  - /riak/2.5.0/dev/references/http/counters
  - /riak/kv/2.5.0/dev/references/http/counters
---
...
The regular POST/PUT ([HTTP Store Object](/riak/kv/2.5.0/developing/api/http/store-object)) and GET ([HTTP Fetch Object](/riak/kv/2.5.0/developing/api/http/fetch-object)) responses apply here.
