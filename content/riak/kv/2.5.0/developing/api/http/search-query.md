...
toc: true
aliases:
  - /riak/2.5.0/dev/references/http/search-query
  - /riak/kv/2.5.0/dev/references/http/search-query
---

Performs a [Riak KV Search](/riak/kv/2.5.0/developing/usage/search) query.
...
* `q` --- The actual Search query itself. Examples can be found in
    [Using Search](/riak/kv/2.5.0/developing/usage/search). If a query is not specified, Riak will return
