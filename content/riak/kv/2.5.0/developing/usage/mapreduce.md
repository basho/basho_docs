...
toc: true
aliases:
  - /riak/2.5.0/dev/using/mapreduce
  - /riak/kv/2.5.0/dev/using/mapreduce
---

[usage 2i]: /riak/kv/2.5.0/developing/usage/secondary-indexes
[usage search]: /riak/kv/2.5.0/developing/usage/search
[usage types]: /riak/kv/2.5.0/developing/usage/bucket-types
[api http]: /riak/kv/2.5.0/developing/api/http
[api pb]: /riak/kv/2.5.0/developing/api/protocol-buffers
[glossary vnode]: /riak/kv/2.5.0/learn/glossary/#vnode
[guide mapreduce]: /riak/kv/2.5.0/developing/app-guide/advanced-mapreduce
