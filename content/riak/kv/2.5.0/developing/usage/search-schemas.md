...
toc: true
aliases:
  - /riak/2.5.0/dev/advanced/search-schema
  - /riak/kv/2.5.0/dev/advanced/search-schema
---
...
under the hood to convert your values---plain text, JSON, XML, [Riak Data Types](/riak/kv/2.5.0/developing/data-types/), and [more](/riak/kv/2.5.0/developing/usage/custom-extractors)---into something that can be indexed and searched later.
...
`_yz_ed`  | Entropy Data | Data related to [active anti-entropy](/riak/kv/2.5.0/learn/concepts/active-anti-entropy)
