...
toc: true
aliases:
  - /riak/2.5.0/dev/using/conflict-resolution/php
  - /riak/kv/2.5.0/dev/using/conflict-resolution/php
---
...
the official PHP client library, in the [Developing with Riak KV: Usage](/riak/kv/2.5.0/developing/usage) section.
