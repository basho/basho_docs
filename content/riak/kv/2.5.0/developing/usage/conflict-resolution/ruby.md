...
toc: true
aliases:
  - /riak/2.5.0/dev/using/conflict-resolution/ruby
  - /riak/kv/2.5.0/dev/using/conflict-resolution/ruby
---
...
the official Ruby client library, in the [Developing with Riak KV: Usage](/riak/kv/2.5.0/developing/usage) section.
