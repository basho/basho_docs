...
toc: true
aliases:
  - /riak/2.5.0/dev/using/conflict-resolution/java
  - /riak/kv/2.5.0/dev/using/conflict-resolution/java
---
...
[bucket type](/riak/kv/2.5.0/developing/usage/bucket-types) `siblings`, and for this bucket type
...
the official Java client library, in the [Developing with Riak KV: Usage](/riak/kv/2.5.0/developing/usage) section.
