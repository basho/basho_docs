...
toc: true
aliases:
  - /riak/2.5.0/dev/using/conflict-resolution/nodejs
  - /riak/kv/2.5.0/dev/using/conflict-resolution/nodejs
---

For reasons explained in the [Introduction to conflict resolution](/riak/kv/2.5.0/developing/usage/conflict-resolution), we strongly recommend adopting a conflict resolution strategy that
