...
toc: true
aliases:
  - /riak/2.5.0/dev/advanced/client-security/python
  - /riak/kv/2.5.0/dev/advanced/client-security/python
---

This tutorial shows you how to set up a Riak Python client to
authenticate itself when connecting to Riak.

If you are using [trust-](/riak/kv/2.5.0/using/security/managing-sources/) or [PAM-](/riak/kv/2.5.0/using/security/managing-sources/#pam-based-authentication), you can use the security
setup described [below](#python-client-basics). [Password](/riak/kv/2.5.0/using/security/managing-sources/#password-based-authentication)-based authentication is covered
in a [later section](#password-based-authentication). If you are using
[certificate](/riak/kv/2.5.0/using/security/managing-sources/#certificate-based-authentication)-based authentication, follow
...
regardless of which [security source](/riak/kv/2.5.0/using/security/managing-sources/) you
...
Authentication](/riak/kv/2.5.0/using/security/managing-sources/#Trust-based-Authentication).
...
To specify a list of preferred [security ciphers](/riak/kv/2.5.0/using/security/basics/#security-ciphers), you can pass in a colon-delimited
