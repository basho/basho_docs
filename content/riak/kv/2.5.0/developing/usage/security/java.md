...
toc: true
aliases:
  - /riak/2.5.0/dev/advanced/client-security/java
  - /riak/kv/2.5.0/dev/advanced/client-security/java
---
...
security setup described [below](#java-client-basics). [Certificate](/riak/kv/2.5.0/using/security/managing-sources/#certificate-based-authentication)-based authentication is not
