...
toc: true
aliases:
  - /riak/2.5.0/dev/advanced/client-security/erlang
  - /riak/kv/2.5.0/dev/advanced/client-security/erlang
---

This tutorial shows you how to set up a Riak Erlang client to
authenticate itself when connecting to Riak.

If you are using [trust](/riak/kv/2.5.0/using/security/managing-sources/), [PAM-](/riak/kv/2.5.0/using/security/managing-sources/#pam-based-authentication), you can use the security setup described [below](#erlang-client-basics). [Password](/riak/kv/2.5.0/using/security/managing-sources/#password-based-authentication)-based authentication is covered
...
on specifying trusted CIDRs can be found in [Trust-based Authentication](/riak/kv/2.5.0/using/security/managing-sources/#trust-based-authentication).
