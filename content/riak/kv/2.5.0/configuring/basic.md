...
toc: true
aliases:
  - /riak/2.5.0/ops/building/configuration/
  - /riak/kv/2.5.0/ops/building/configuration/
---

[config reference]: /riak/kv/2.5.0/configuring/reference
[use running cluster]: /riak/kv/2.5.0/using/running-a-cluster
[use admin riak-admin#member-status]: /riak/kv/2.5.0/using/admin/riak-admin/#member-status
...
[Cluster Capacity Planning]: /riak/kv/2.5.0/setup/planning/cluster-capacity/#ring-size-number-of-partitions
...
directly impacted, although the mechanism described in [HTTP Reset Bucket Properties](/riak/kv/2.5.0/developing/api/http/reset-bucket-props) can be used to force them to pick up the new
defaults.
