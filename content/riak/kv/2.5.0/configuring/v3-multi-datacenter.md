...
aliases:
  - /riak/2.5.0/ops/mdc/v3/configuration
  - /riak/kv/2.5.0/ops/mdc/v3/configuration
---

[config reference#advanced]: /riak/kv/2.5.0/configuring/reference/#advanced-configuration
[config v3 ssl#verify-peer]: /riak/kv/2.5.0/configuring/v3-multi-datacenter/ssl/#verifying-peer-certificates
