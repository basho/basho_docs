...
aliases:
  ...
  - /riak/kv/2.9.7/ops/advanced/install-custom-code/
---
...
Your developers can compile [custom erlang code]({{<baseurl>}}riak/kv/2.9.7/developing/usage/commit-hooks), which
...
in the [Commands documentation]({{<baseurl>}}riak/kv/2.9.7/using/admin/riak-admin/#wait-for-service).
