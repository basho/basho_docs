...
as <a href="{{< baseurl >}}riak/kv/2.9.7/learn/glossary/#active-anti-entropy-aae">active anti-entropy</a> data, and cluster metadata.</td>
...
associated <a href="{{< baseurl >}}riak/kv/2.9.7/learn/glossary/#vnode">vnode</a> before assuming that the vnode
...
href="{{< baseurl >}}riak/kv/2.9.7/learn/glossary/#vnode">vnodes</a> attempt to trigger <a
href="{{< baseurl >}}riak/kv/2.9.7/learn/glossary/#hinted-handoff">handoff</a> between
