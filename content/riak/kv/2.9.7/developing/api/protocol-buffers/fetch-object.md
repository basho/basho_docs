...
[`RpbPutResp`]({{<baseurl>}}riak/kv/2.9.7/developing/api/protocol-buffers/store-object), respectively):
...
* `content_encoding` - The content encoding of the object, e.g.
  `video/mp4`
* `vtag` - The object's [vtag]({{<baseurl>}}riak/kv/2.9.7/learn/glossary/#vector-clock)
