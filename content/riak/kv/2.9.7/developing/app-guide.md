...
aliases:
  ...
  - /riak/kv/2.9.7/dev/using/application-guide/
---
...
[dev data model#user]: {{<baseurl>}}riak/kv/2.9.7/developing/data-modeling/#user-data
...
[dev data types#counters]: {{<baseurl>}}riak/kv/2.9.7/developing/data-types/#counters
[dev data types#sets]: {{<baseurl>}}riak/kv/2.9.7/developing/data-types/#sets
[dev data types#maps]: {{<baseurl>}}riak/kv/2.9.7/developing/data-types/#maps
