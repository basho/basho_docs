...
aliases:
  ...
  - /riak/kv/2.9.7/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/2.9.7/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/2.9.7/using/admin/riak-admin/#aae-status
