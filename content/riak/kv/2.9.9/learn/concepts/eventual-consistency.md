...
special eventually consistent [Data Types]({{<baseurl>}}riak/kv/2.9.9/developing/data-types/), or you can resolve those
...
or models]({{<baseurl>}}riak/kv/2.9.9/developing/data-modeling/).
