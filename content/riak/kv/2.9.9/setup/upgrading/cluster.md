...
[jmx monitor]: {{<baseurl>}}riak/kv/2.9.9/using/reference/jmx
[snmp]: {{<baseurl>}}riak/kv/2.9.9/using/reference/snmp
...
If you run [Riak Control]({{<baseurl>}}riak/kv/2.9.9/using/admin/riak-control), you should disable it during the rolling upgrade process.
{{% /note %}}
