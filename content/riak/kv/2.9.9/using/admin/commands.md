...
[use admin riak-admin#cluster-plan]: {{<baseurl>}}riak/kv/2.9.9/using/admin/riak-admin/#cluster-plan
[use admin riak-admin#cluster-commit]: {{<baseurl>}}riak/kv/2.9.9/using/admin/riak-admin/#cluster-commit
