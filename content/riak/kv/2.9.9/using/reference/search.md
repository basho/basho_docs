...
[configuring search]: {{<baseurl>}}riak/kv/2.9.9/configuring/search
...
search, you should check out the [Using Search]({{<baseurl>}}riak/kv/2.9.9/developing/usage/search) document.
...
See the [main Search documentation]({{<baseurl>}}riak/kv/2.9.9/developing/usage/search/#simple-setup) for details on creating an index.
...
You can also find more information on to how customize your own [search schema]({{<baseurl>}}riak/kv/2.9.9/developing/usage/search-schemas).
...
[Active Anti-Entropy]({{<baseurl>}}riak/kv/2.9.9/learn/concepts/active-anti-entropy/) \(AAE) is the process of discovering and
...
information on analysis, see [Search Schema]({{<baseurl>}}riak/kv/2.9.9/developing/usage/search-schemas).
