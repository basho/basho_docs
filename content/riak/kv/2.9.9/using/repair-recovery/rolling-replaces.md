...
[rolling restarts]: {{<baseurl>}}riak/kv/2.9.9/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}riak/kv/2.9.9/using/cluster-operations/adding-removing-nodes
