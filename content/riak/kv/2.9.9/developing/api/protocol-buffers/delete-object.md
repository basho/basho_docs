...
aliases:
  ...
  - /riak/kv/2.9.9/dev/references/protocol-buffers/delete-object
---

Delete an object in the specified [bucket type]({{<baseurl>}}riak/kv/2.9.9/using/cluster-operations/bucket-types)/bucket/key location.
