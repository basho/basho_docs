...
aliases:
  ...
  - /riak/kv/2.9.9/dev/using/conflict-resolution/php
---
...
the official PHP client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/2.9.9/developing/usage) section.
