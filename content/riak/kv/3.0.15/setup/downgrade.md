...
aliases:
  ...
  - /riak/kv/3.0.15/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/3.0.15/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/3.0.15/using/admin/riak-admin/#aae-status
