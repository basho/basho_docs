...
aliases:
  ...
  - /riak/kv/3.0.15/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak/3.0.15/installing/amazon-web-services/
  - /riak/kv/3.0.15/installing/amazon-web-services/
---
...
We also recommend that you read more about Riak's [Security and Firewalls]({{<baseurl>}}riak/kv/3.0.15/using/security/).
...
```bash
wget https://files.tiot.jp/riak/kv/3.0/3.0.15/amazon/2016.09/riak-3.0.15-1.amzn1x86_64.rpm
