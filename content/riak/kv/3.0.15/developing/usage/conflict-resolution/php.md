...
aliases:
  ...
  - /riak/kv/3.0.15/dev/using/conflict-resolution/php
---
...
the official PHP client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/3.0.15/developing/usage) section.
