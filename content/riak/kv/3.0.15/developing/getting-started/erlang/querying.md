...
aliases:
  ...
  - /riak/kv/3.0.15/dev/taste-of-riak/querying-erlang
---
...
A more comprehensive discussion can be found in [Key/Value Modeling]({{<baseurl>}}riak/kv/3.0.15/developing/key-value-modeling).
