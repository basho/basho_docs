...
aliases:
  ...
  - /riak/kv/3.0.15/dev/taste-of-riak/golang
---

If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}riak/kv/3.0.15/using/running-a-cluster) first and ensure you have
...
[CRUD Operations]({{<baseurl>}}riak/kv/3.0.15/developing/getting-started/golang/crud-operations)
