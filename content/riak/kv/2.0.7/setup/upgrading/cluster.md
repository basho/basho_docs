...
[production checklist]: /riak/kv/2.0.7/setup/upgrading/checklist
...
[release notes]: /riak/kv/2.0.7/release-notes/
...
[jmx monitor]: /riak/kv/2.0.7/using/reference/jmx
[snmp]: /riak/kv/2.0.7/using/reference/snmp
...
If you run [Riak Control](/riak/kv/2.0.7/using/admin/riak-control), you should disable it during the rolling upgrade process.
{{% /note %}}
...
reformat the indexes using the [`riak-admin reformat-indexes`](/riak/kv/2.0.7/using/admin/riak-admin) command. More details about reformatting indexes are available in the [release notes](/riak/kv/2.0.7/release-notes/).
{{% /note %}}
