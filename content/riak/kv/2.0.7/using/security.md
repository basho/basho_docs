...
aliases:
  ...
  - /riak/kv/2.0.7/ops/advanced/security
...
[Authentication and Authorization](/riak/kv/2.0.7/using/security/basics) and [Managing Security Sources](/riak/kv/2.0.7/using/security/managing-sources/)
...
Riak's [search](/riak/kv/2.0.7/developing/usage/search/) feature relies on [Apache
Solr](http://lucene.apache.org/solr/), which runs on each Riak node if
security has been [enabled](/riak/kv/2.0.7/configuring/search/#enabling-riak-search). When Riak's Search subsystem starts up,
...
node's [Search configuration](/riak/kv/2.0.7/configuring/reference/#search). The default is 8985.
...
authentication, please see our documentation on [Riak Security](/riak/kv/2.0.7/using/security/basics).
...
[Security and Firewalls](/riak/kv/2.0.7/using/security/basics).
...
See also: [Multi Data Center Replication: SSL](/riak/kv/2.0.7/configuring/v3-multi-datacenter/ssl) in the Enterprise
Documentation.
