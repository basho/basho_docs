...
[use admin commands#join]: /riak/kv/2.0.7/using/admin/commands/#join
[use admin commands#leave]: /riak/kv/2.0.7/using/admin/commands/#leave
[cluster ops backup]: /riak/kv/2.0.7/using/cluster-operations/backing-up
[config reference#node-metadata]: /riak/kv/2.0.7/configuring/reference/#node-metadata
...
[config reference#ring]: /riak/kv/2.0.7/configuring/reference/#ring
...
[downgrade]: /riak/kv/2.0.7/setup/upgrading/downgrade
...
[use admin riak-admin#stats]: /riak/kv/2.0.7/using/admin/riak-admin/#stats
