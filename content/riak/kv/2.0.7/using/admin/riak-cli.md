...
[configuration file]: {{<baseurl>}}riak/kv/2.0.7/configuring/reference/
[escript]: http://www.erlang.org/doc/man/escript.html
[`riak-admin`]: {{<baseurl>}}riak/kv/2.0.7/using/admin/riak-admin/#top
[configuration]: {{<baseurl>}}riak/kv/2.0.7/configuring/reference/
