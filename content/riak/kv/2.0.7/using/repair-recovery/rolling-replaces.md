...
[upgrade]: /riak/kv/2.0.7/setup/upgrading/cluster/
[rolling restarts]: /riak/kv/2.0.7/using/repair-recovery/rolling-restart/
[add node]: /riak/kv/2.0.7/using/cluster-operations/adding-removing-nodes
