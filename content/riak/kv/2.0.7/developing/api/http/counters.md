...
aliases:
  ...
  - /riak/kv/2.0.7/dev/references/http/counters
canonical_link: "https://docs.basho.com/riak/kv/latest/developing/api/http/counters"
---
...
The regular POST/PUT ([HTTP Store Object](/riak/kv/2.0.7/developing/api/http/store-object)) and GET ([HTTP Fetch Object](/riak/kv/2.0.7/developing/api/http/fetch-object)) responses apply here.
