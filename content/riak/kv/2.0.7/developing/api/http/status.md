...
aliases:
  ...
  - /riak/kv/2.0.7/dev/references/http/status
canonical_link: "https://docs.basho.com/riak/kv/latest/developing/api/http/status"
---
...
The output of `/stats` contains the output of `riak-admin status` detailed in the [Inspecting a Node](/riak/kv/2.0.7/using/cluster-operations/inspecting-node) doc, plus the below stats generated by the Riak Core application.
