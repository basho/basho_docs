...
aliases:
  ...
  - /riak/kv/2.0.7/dev/taste-of-riak/erlang
---

If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}riak/kv/2.0.7/using/running-a-cluster) first.
...
[CRUD Operations]({{<baseurl>}}riak/kv/2.0.7/developing/getting-started/erlang/crud-operations)
