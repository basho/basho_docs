...
features recently added to Riak---[Riak Search]({{<baseurl>}}riak/kv/2.0.7/developing/usage/search/) and [Riak Data Types]({{<baseurl>}}riak/kv/2.0.7/developing/data-types/)---make it possible to use Riak as a
...
[Riak maps]({{<baseurl>}}riak/kv/2.0.7/developing/data-types/#maps).
...
however, we will store data in [Riak maps]({{<baseurl>}}riak/kv/2.0.7/developing/data-types/#maps),
...
In the documentation on [search schemas]({{<baseurl>}}riak/kv/2.0.7/developing/usage/search-schemas), you'll find a
...
described in [Data Modeling with Riak Data Types]({{<baseurl>}}riak/kv/2.0.7/developing/data-modeling), we can construct a
