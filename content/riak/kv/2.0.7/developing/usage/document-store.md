...
In the documentation on [search schemas](/riak/kv/2.0.7/developing/usage/search-schemas), you'll find a
...
described in [Data Modeling with Riak Data Types](/riak/kv/2.0.7/developing/data-modeling), we can construct a
