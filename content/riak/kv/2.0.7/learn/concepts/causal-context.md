...
[dev key value]: /riak/kv/2.0.7/developing/key-value-modeling
[glossary read rep]: /riak/kv/2.0.7/learn/glossary/#read-repair
[perf latency reduc]: /riak/kv/2.0.7/using/performance/latency-reduction
...
[usage protocol buffers]: /riak/kv/2.0.7/developing/api/protocol-buffers
[usage updating objects]: /riak/kv/2.0.7/developing/usage/updating-objects
...
[using bucket types](/riak/kv/2.0.7/developing/usage/bucket-types), all writes to that bucket will create siblings
