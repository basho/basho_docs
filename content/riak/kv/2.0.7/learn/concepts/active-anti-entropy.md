...
aliases:
  ...
  - /riak/kv/2.0.7/theory/concepts/aae
---

[cluster ops v3 mdc]: {{<baseurl>}}riak/kv/2.0.7/using/cluster-operations/v3-multi-datacenter
[cluster ops aae]: {{<baseurl>}}riak/kv/2.0.7/using/cluster-operations/active-anti-entropy
...
[config aae]: {{<baseurl>}}riak/kv/2.0.7/configuring/reference/#active-anti-entropy
