...
aliases:
  ...
  - /riak/kv/3.0.1/dev/taste-of-riak/querying-erlang
...
A more comprehensive discussion can be found in [Key/Value Modeling]({{<baseurl>}}riak/kv/3.0.1/developing/key-value-modeling).
