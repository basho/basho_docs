...
aliases:
  ...
  - /riak/kv/3.0.1/dev/using/conflict-resolution/java
...
the official Java client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/3.0.1/developing/usage) section.
