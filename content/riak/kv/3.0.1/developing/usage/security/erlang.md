...
on specifying trusted CIDRs can be found in [Trust-based Authentication]({{<baseurl>}}riak/kv/3.0.1/using/security/managing-sources/#trust-based-authentication).
