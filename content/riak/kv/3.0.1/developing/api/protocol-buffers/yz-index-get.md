...
binary (as `name`). Optionally, you can specify a [`schema`]({{<baseurl>}}riak/kv/3.0.1/developing/usage/search-schemas) name and/or an `n_val`, i.e. the number of nodes on which the
