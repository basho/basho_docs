...
aliases:
  ...
  - /riak/kv/3.0.1/ops/mdc/v2/configuration
...
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}riak/kv/3.0.1/configuring/v3-multi-datacenter/) instead.
{{% /note %}}
