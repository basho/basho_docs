...
bucket's [bucket type]({{<baseurl>}}riak/kv/3.0.1/developing/usage/bucket-types).
...
[Multi-Datacenter Replications]({{<baseurl>}}riak/kv/3.0.1/setup/planning/backend/multi) capabilities.
...
type]({{<baseurl>}}riak/kv/3.0.1/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index]({{<baseurl>}}riak/kv/3.0.1/developing/usage/secondary-indexes/) and
[MapReduce]({{<baseurl>}}riak/kv/3.0.1/developing/usage/mapreduce/) queries. Lowering an object or bucket's
