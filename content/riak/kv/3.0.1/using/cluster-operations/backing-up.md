...
aliases:
  ...
  - /riak/kv/3.0.1/ops/running/backups
...
[aae read repair]: {{<baseurl>}}riak/kv/3.0.1/learn/concepts/active-anti-entropy/#read-repair-vs-active-anti-entropy
...
{{% note %}}
For more information on the `riak admin cluster` commands, refer to our documentation on [cluster administration]({{<baseurl>}}riak/kv/3.0.1/using/admin/).
{{% /note %}}
...
Restoring a cluster from backups is documented [on its own page]({{<baseurl>}}riak/kv/3.0.1/using/repair-recovery/failure-recovery/#cluster-recovery-from-backups).
