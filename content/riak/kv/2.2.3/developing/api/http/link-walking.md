...
is a special case of [MapReduce]({{<baseurl>}}riak/kv/2.2.3/developing/usage/mapreduce), and can be expressed more verbosely as such.
[Read more about Links]({{<baseurl>}}riak/kv/2.2.3/learn/glossary/#links).
...
response from [fetching the object]({{<baseurl>}}riak/kv/2.2.3/developing/api/http/fetch-object), without the status
code.
