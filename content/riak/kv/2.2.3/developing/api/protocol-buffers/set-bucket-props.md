...
[PBC Get Bucket Properties](/riak/kv/2.2.3/developing/api/protocol-buffers/get-bucket-props) documentation.

You can also specify a [bucket type](/riak/kv/2.2.3/developing/usage/bucket-types) using the
