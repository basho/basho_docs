...
aliases:
  ...
  - /riak/kv/3.0.14/dev/using/conflict-resolution/php
---
...
the official PHP client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/3.0.14/developing/usage) section.
