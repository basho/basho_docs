...
aliases:
  ...
  - /riak/kv/3.0.14/dev/taste-of-riak/csharp
---

If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}riak/kv/3.0.14/using/running-a-cluster) first.
...
[CRUD Operations]({{<baseurl>}}riak/kv/3.0.14/developing/getting-started/csharp/crud-operations)
