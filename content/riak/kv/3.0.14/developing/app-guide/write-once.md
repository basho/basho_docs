...
aliases:
  ...
  - /riak/kv/3.0.14/dev/advanced/write-once
---
...
[Riak data types]: {{<baseurl>}}riak/kv/3.0.14/developing/data-types
[strong consistency]: {{<baseurl>}}riak/kv/3.0.14/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}riak/kv/3.0.14/setup/planning/backend/multi) backend does not
