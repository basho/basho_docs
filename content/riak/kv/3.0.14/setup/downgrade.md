...
aliases:
  ...
  - /riak/kv/3.0.14/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/3.0.14/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/3.0.14/using/admin/riak admin/#aae-status
