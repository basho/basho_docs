...
aliases:
  ...
  - /riak/kv/3.2.0/dev/advanced/write-once
---
...
[strong consistency]: {{<baseurl>}}riak/kv/3.2.0/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}riak/kv/3.2.0/setup/planning/backend/multi) backend does not
