...
toc: true
aliases:
  - /riak/3.2.0/ops/advanced/configs/search/
  - /riak/kv/3.2.0/ops/advanced/configs/search/
---

[usage search]: {{<baseurl>}}riak/kv/3.2.0/developing/usage/search
[usage search schema]: {{<baseurl>}}riak/kv/3.2.0/developing/usage/search-schemas
[usage search data types]: {{<baseurl>}}riak/kv/3.2.0/developing/usage/searching-data-types
[usage custom extractors]: {{<baseurl>}}riak/kv/3.2.0/developing/usage/custom-extractors
[cluster-ops aae throttle]: {{<baseurl>}}riak/kv/3.2.0/using/cluster-operations/active-anti-entropy/#throttling
[config reference]: {{<baseurl>}}riak/kv/3.2.0/configuring/reference
[config reference#search]: {{<baseurl>}}riak/kv/3.2.0/configuring/reference/#search
