...
aliases:
  ...
  - /riak/kv/3.2.0/ops/building/installing/Installing-on-FreeBSD
  - /riak/3.2.0/installing/freebsd/
  - /riak/kv/3.2.0/installing/freebsd/
---
...
```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/3.0/3.2.0/freebsd/11.1/riak-3.2.0.txz
```
...
```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/3.0/3.2.0/freebsd/10.4/riak-3.2.0.txz
```
