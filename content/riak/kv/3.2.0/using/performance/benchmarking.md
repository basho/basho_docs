...
aliases:
  ...
  - /riak/kv/3.2.0/ops/building/benchmarking
---
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}riak/kv/3.2.0/setup/installing/source/erlang) for instructions
