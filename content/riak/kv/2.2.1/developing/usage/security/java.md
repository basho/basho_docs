...
security setup described [below](#java-client-basics). [Certificate](/riak/kv/2.2.1/using/security/managing-sources/#certificate-based-authentication)-based authentication is not
