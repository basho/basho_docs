...
aliases:
  ...
  - /riak/kv/2.2.1/dev/references/protocol-buffers/reset-bucket-props
---
...
[bucket type]({{<baseurl>}}riak/kv/2.2.1/developing/usage/bucket-types) using the `type` value. If you do not
