...
aliases:
  ...
  - /riak/kv/2.2.1/dev/references/protocol-buffers/yz-schema-get
---

Fetch a [search schema]({{<baseurl>}}riak/kv/2.2.1/developing/usage/search-schemas) from Riak Search.
