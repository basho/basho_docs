...
aliases:
  ...
  - /riak/kv/2.2.1/dev/references/protocol-buffers/get-client-id
---
...
connected and can be changed using [Set Client ID]({{<baseurl>}}riak/kv/2.2.1/developing/api/protocol-buffers/set-client-id).
