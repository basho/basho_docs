...
aliases:
  ...
  - /riak/kv/2.2.1/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak/2.2.1/installing/amazon-web-services/
  - /riak/kv/2.2.1/installing/amazon-web-services/
---
...
We also recommend that you read more about Riak's [Security and Firewalls]({{<baseurl>}}riak/kv/2.2.1/using/security/).
