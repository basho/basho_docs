...
aliases:
  ...
  - /riak/kv/2.2.1/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/2.2.1/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/2.2.1/using/admin/riak-admin/#aae-status
