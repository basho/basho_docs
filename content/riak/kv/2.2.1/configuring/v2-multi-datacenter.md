...
aliases:
  ...
  - /riak/kv/2.2.1/ops/mdc/v2/configuration
---

[config v2 ssl]: /riak/kv/2.2.1/configuring/v2-multi-datacenter/ssl

{{% note title="Deprecation Warning" %}}
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3](/riak/kv/2.2.1/configuring/v3-multi-datacenter/) instead.
{{% /note %}}
