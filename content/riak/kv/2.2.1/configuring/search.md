...
[cluster-ops aae throttle]: {{<baseurl>}}riak/kv/2.2.1/using/cluster-operations/active-anti-entropy/#throttling
[config reference]: {{<baseurl>}}riak/kv/2.2.1/configuring/reference
[config reference#search]: {{<baseurl>}}riak/kv/2.2.1/configuring/reference/#search
