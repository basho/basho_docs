...
aliases:
  ...
  - /riak/kv/2.2.1/ops/building/benchmarking
---
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}riak/kv/2.2.1/setup/installing/source/erlang) for instructions
