...
[upgrade]: {{<baseurl>}}riak/kv/2.2.1/setup/upgrading/cluster/
[rolling restarts]: {{<baseurl>}}riak/kv/2.2.1/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}riak/kv/2.2.1/using/cluster-operations/adding-removing-nodes
