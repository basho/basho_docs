...
[upgrade]: /riak/kv/2.2.1/setup/upgrading/cluster/
[rolling restarts]: /riak/kv/2.2.1/using/repair-recovery/rolling-restart/
[add node]: /riak/kv/2.2.1/using/cluster-operations/adding-removing-nodes
