...
aliases:
  ...
  - /riak/kv/2.2.1/ops/running/tools/riak-admin
---

[config reference]: /riak/kv/2.2.1/configuring/reference
[use admin commands]: /riak/kv/2.2.1/using/admin/commands
[use admin commands#join]: /riak/kv/2.2.1/using/admin/commands/#join
[use admin commands#leave]: /riak/kv/2.2.1/using/admin/commands/#leave
[cluster ops backup]: /riak/kv/2.2.1/using/cluster-operations/backing-up
[config reference#node-metadata]: /riak/kv/2.2.1/configuring/reference/#node-metadata
...
[config reference#ring]: /riak/kv/2.2.1/configuring/reference/#ring
...
[use admin riak-admin#stats]: /riak/kv/2.2.1/using/admin/riak-admin/#stats
