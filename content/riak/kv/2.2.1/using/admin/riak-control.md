...
aliases:
  ...
  - /riak/kv/2.2.1/ops/advanced/riak-control
---
...
enabled on each Riak node. For more information, see our [security documentation]({{<baseurl>}}riak/kv/2.2.1/using/security/basics#enabling-ssl). Once SSL is enabled, you can proceed to setting up [authentication](#authentication) for Riak Control.
...
see the health of each [vnode]({{<baseurl>}}riak/kv/2.2.1/learn/glossary/#vnode).
