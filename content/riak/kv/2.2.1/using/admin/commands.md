...
aliases:
  ...
  - /riak/kv/2.2.1/ops/running/cluster-admin
---
...
[use admin riak-admin#cluster-plan]: /riak/kv/2.2.1/using/admin/riak-admin/#cluster-plan
[use admin riak-admin#cluster-commit]: /riak/kv/2.2.1/using/admin/riak-admin/#cluster-commit
