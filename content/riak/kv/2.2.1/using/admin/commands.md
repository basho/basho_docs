...
[use admin riak-admin#cluster-plan]: {{<baseurl>}}riak/kv/2.2.1/using/admin/riak-admin/#cluster-plan
[use admin riak-admin#cluster-commit]: {{<baseurl>}}riak/kv/2.2.1/using/admin/riak-admin/#cluster-commit
