...
[glossary ring]: /riak/kv/2.2.1/learn/glossary/#ring
...
bucket's [bucket type](/riak/kv/2.2.1/developing/usage/bucket-types).
...
[Multi-Datacenter Replications](/riak/kv/2.2.1/setup/planning/backend/multi) capabilities.
...
type](/riak/kv/2.2.1/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index](/riak/kv/2.2.1/developing/usage/secondary-indexes/) and
[MapReduce](/riak/kv/2.2.1/developing/usage/mapreduce/) queries. Lowering an object or bucket's
