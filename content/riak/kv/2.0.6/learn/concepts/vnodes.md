...
[concept clusters ring]: {{<baseurl>}}riak/kv/2.0.6/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}riak/kv/2.0.6/setup/planning/backend/bitcask) as a backend, navigate
