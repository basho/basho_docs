...
[cluster ops aae]: {{<baseurl>}}riak/kv/2.0.6/using/cluster-operations/active-anti-entropy
...
[config aae]: {{<baseurl>}}riak/kv/2.0.6/configuring/reference/#active-anti-entropy
