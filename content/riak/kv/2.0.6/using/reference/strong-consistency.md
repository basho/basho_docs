...
consistency involves a complex [consensus subsystem](/riak/kv/2.0.6/learn/concepts/strong-consistency/#Implementation-Details) that typically requires more communication between Riak nodes than eventually consistent operations,
