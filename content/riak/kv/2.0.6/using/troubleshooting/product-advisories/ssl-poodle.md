...
To verify that the patch has been installed properly, run the [`riak attach`](/riak/kv/2.0.6/using/admin/riak-cli/#attach) command (or [`riak-cs attach`](/riak/cs/2.1.1/cookbooks/command-line-tools/#riak-cs)).
