...
[use admin riak-admin#cluster]: /riak/kv/2.0.6/using/admin/riak-admin/#cluster
...
[use admin riak-admin#cluster-plan]: /riak/kv/2.0.6/using/admin/riak-admin/#cluster-plan
[use admin riak-admin#cluster-commit]: /riak/kv/2.0.6/using/admin/riak-admin/#cluster-commit
