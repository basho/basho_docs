...
aliases:
  ...
  - /riak/kv/2.0.6/ops/running/cluster-admin
---

[use admin riak-admin#cluster]: {{<baseurl>}}riak/kv/2.0.6/using/admin/riak-admin/#cluster
...
[use admin riak-admin#cluster-plan]: {{<baseurl>}}riak/kv/2.0.6/using/admin/riak-admin/#cluster-plan
[use admin riak-admin#cluster-commit]: {{<baseurl>}}riak/kv/2.0.6/using/admin/riak-admin/#cluster-commit
