...
application will be stored in buckets that bear the [bucket type](/riak/kv/2.0.6/developing/usage/bucket-types) `siblings`, and for this bucket type `allow_mult` is set
...
the official Ruby client library, in the [Developing with Riak KV: Usage](/riak/kv/2.0.6/developing/usage) section.
