...
aliases:
  ...
  - /riak/kv/2.0.6/dev/using/conflict-resolution/php
---
...
[bucket type]({{<baseurl>}}riak/kv/2.0.6/developing/usage/bucket-types) `siblings`, and for this bucket type
...
the official PHP client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/2.0.6/developing/usage) section.
