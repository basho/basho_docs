...
[sibling explosion](/riak/kv/2.0.6/using/performance/latency-reduction#siblings), which can
...
the entire node. Other issues include [increased cluster latency](/riak/kv/2.0.6/using/performance/latency-reduction) as the object is replicated and out-of-memory errors.
