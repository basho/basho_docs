...
aliases:
  ...
  - /riak/kv/2.0.6/dev/taste-of-riak/querying-erlang
---
...
A more comprehensive discussion can be found in [Key/Value Modeling]({{<baseurl>}}riak/kv/2.0.6/developing/key-value-modeling).
