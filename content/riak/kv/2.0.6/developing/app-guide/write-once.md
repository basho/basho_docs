...
When the new `write_once` [bucket type](/riak/kv/2.0.6/developing/usage/bucket-types) parameter is set to
...
The `write_once` property is incompatible with [Riak data types](/riak/kv/2.0.6/developing/data-types/) and [strong consistency](/riak/kv/2.0.6/developing/app-guide/strong-consistency/),
...
The [Multi](/riak/kv/2.0.6/setup/planning/backend/multi) backend does not support asynchronous writes. Therefore, if
