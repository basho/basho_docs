...
aliases:
  ...
  - /riak/kv/2.0.6/dev/references/protocol-buffers/set-bucket-props
...
[PBC Get Bucket Properties](/riak/kv/2.0.6/developing/api/protocol-buffers/get-bucket-props) documentation.

You can also specify a [bucket type](/riak/kv/2.0.6/developing/usage/bucket-types) using the
