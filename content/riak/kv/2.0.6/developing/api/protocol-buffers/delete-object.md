...
canonical_link: "docs.basho.com/riak/kv/latest/developing/api/protocol-buffers/delete-object.md"
---

Delete an object in the specified [bucket type](/riak/kv/2.0.6/using/cluster-operations/bucket-types)/bucket/key location.
