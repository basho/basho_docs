...
An operation to update a [counter]({{<baseurl>}}riak/kv/2.0.6/developing/data-types).
...
stored on their own in a key or [within a map]({{<baseurl>}}riak/kv/2.0.6/developing/api/protocol-buffers/dt-map-store).
