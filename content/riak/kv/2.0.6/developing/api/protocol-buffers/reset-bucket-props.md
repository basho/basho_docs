...
aliases:
  ...
  - /riak/kv/2.0.6/dev/references/protocol-buffers/reset-bucket-props
...
[bucket type](/riak/kv/2.0.6/developing/usage/bucket-types) using the `type` value. If you do not
