...
is a special case of [MapReduce](/riak/kv/2.0.6/developing/usage/mapreduce), and can be expressed more verbosely as such.
[Read more about Links](/riak/kv/2.0.6/learn/glossary/#links).
...
response from [fetching the object](/riak/kv/2.0.6/developing/api/http/fetch-object), without the status
code.
