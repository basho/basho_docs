...
aliases:
  ...
  - /riak/kv/3.0.6/ops/advanced/configs/configuration-files/
---
...
as <a href="{{< baseurl >}}riak/kv/3.0.6/learn/glossary/#active-anti-entropy-aae">active anti-entropy</a> data, and cluster metadata.</td>
...
associated <a href="{{< baseurl >}}riak/kv/3.0.6/learn/glossary/#vnode">vnode</a> before assuming that the vnode
...
href="{{< baseurl >}}riak/kv/3.0.6/learn/glossary/#vnode">vnodes</a> attempt to trigger <a
href="{{< baseurl >}}riak/kv/3.0.6/learn/glossary/#hinted-handoff">handoff</a> between
