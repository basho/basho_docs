...
aliases:
  ...
  - /riak/kv/3.0.6/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/3.0.6/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/3.0.6/using/admin/riak admin/#aae-status
