...
aliases:
  ...
  - /riak/kv/3.0.6/dev/using/application-guide/
---

[usage conflict resolution]: {{<baseurl>}}riak/kv/3.0.6/developing/usage/conflict-resolution
[dev data model#log]: {{<baseurl>}}riak/kv/3.0.6/developing/data-modeling/#log-data
[dev data model#sensor]: {{<baseurl>}}riak/kv/3.0.6/developing/data-modeling/#sensor-data
[concept eventual consistency]: {{<baseurl>}}riak/kv/3.0.6/learn/concepts/eventual-consistency
[dev data model#user]: {{<baseurl>}}riak/kv/3.0.6/developing/data-modeling/#user-data
...
[dev data types#counters]: {{<baseurl>}}riak/kv/3.0.6/developing/data-types/#counters
