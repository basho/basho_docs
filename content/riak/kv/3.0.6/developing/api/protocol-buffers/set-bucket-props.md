...
aliases:
  ...
  - /riak/kv/3.0.6/dev/references/protocol-buffers/set-bucket-props
---
...
[PBC Get Bucket Properties]({{<baseurl>}}riak/kv/3.0.6/developing/api/protocol-buffers/get-bucket-props) documentation.

You can also specify a [bucket type]({{<baseurl>}}riak/kv/3.0.6/developing/usage/bucket-types) using the
