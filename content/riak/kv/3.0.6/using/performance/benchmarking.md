...
aliases:
  ...
  - /riak/kv/3.0.6/ops/building/benchmarking
---
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}riak/kv/3.0.6/setup/installing/source/erlang) for instructions
