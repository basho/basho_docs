...
toc: true
aliases:
  - /riak-docs/riak/2.2.6/dev/using/data-types/counters
  - /riak-docs/riak/kv/2.2.6/dev/using/data-types/counters
  - /riak-docs/riak/2.2.6/dev/data-modeling/data-types/counters
  - /riak-docs/riak/kv/2.2.6/dev/data-modeling/data-types/counters
---
