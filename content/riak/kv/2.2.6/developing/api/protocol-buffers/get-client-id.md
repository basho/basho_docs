...
toc: true
aliases:
  - /riak-docs/riak/2.2.6/dev/references/protocol-buffers/get-client-id
  - /riak-docs/riak/kv/2.2.6/dev/references/protocol-buffers/get-client-id
---
...
connected and can be changed using [Set Client ID]({{<baseurl>}}riak/kv/2.2.6/developing/api/protocol-buffers/set-client-id).
