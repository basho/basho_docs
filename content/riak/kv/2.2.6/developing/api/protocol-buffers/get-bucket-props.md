...
toc: true
aliases:
  - /riak-docs/riak/2.2.6/dev/references/protocol-buffers/get-bucket-props
  - /riak-docs/riak/kv/2.2.6/dev/references/protocol-buffers/get-bucket-props
---
...
The bucket's name (`bucket`) must be specified. The [bucket type]({{<baseurl>}}riak/kv/2.2.6/using/cluster-operations/bucket-types) parameter (`type`) is optional. If it is not specified,
...
[configuration file]({{<baseurl>}}riak/kv/2.2.6/configuring/reference/#default-bucket-properties) documentation.
