...
toc: true
aliases:
  - /riak-docs/riak/2.2.6/dev/taste-of-riak/python
  - /riak-docs/riak/kv/2.2.6/dev/taste-of-riak/python
---
...
[CRUD Operations]({{<baseurl>}}riak/kv/2.2.6/developing/getting-started/python/crud-operations)
