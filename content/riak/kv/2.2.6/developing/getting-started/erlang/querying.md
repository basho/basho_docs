...
toc: true
aliases:
  - /riak-docs/riak/2.2.6/dev/taste-of-riak/querying-erlang
  - /riak-docs/riak/kv/2.2.6/dev/taste-of-riak/querying-erlang
---
...
A more comprehensive discussion can be found in [Key/Value Modeling]({{<baseurl>}}riak/kv/2.2.6/developing/key-value-modeling).
