...
toc: true
aliases:
  - /riak-docs/riak/2.2.6/dev/taste-of-riak/erlang
  - /riak-docs/riak/kv/2.2.6/dev/taste-of-riak/erlang
---
...
[CRUD Operations]({{<baseurl>}}riak/kv/2.2.6/developing/getting-started/erlang/crud-operations)
