...
toc: true
aliases:
  - /riak-docs/riak/2.2.6/dev/taste-of-riak/php
  - /riak-docs/riak/kv/2.2.6/dev/taste-of-riak/php
---
...
[CRUD Operations]({{<baseurl>}}riak/kv/2.2.6/developing/getting-started/php/crud-operations)
