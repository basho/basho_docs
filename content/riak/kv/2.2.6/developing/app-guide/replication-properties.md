...
`pr` | PR | `0` | The number of primary <a href="http://docs.basho.com/riak/kv/2.2.6/learn/concepts/vnodes/">vnodes</a> that must respond to a read request
`pw` | PW | `0` | The number of primary <a href="http://docs.basho.com/riak/kv/2.2.6/learn/concepts/vnodes/">vnodes</a> that must respond to a write request
