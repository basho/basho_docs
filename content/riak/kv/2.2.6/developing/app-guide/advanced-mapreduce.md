...
toc: true
aliases:
  - /riak-docs/riak/2.2.6/dev/advanced/mapreduce/
  - /riak-docs/riak/kv/2.2.6/dev/advanced/mapreduce/
---
...
[installing custom code]({{<baseurl>}}riak/kv/2.2.6/using/reference/custom-code).
{{% /note %}}
