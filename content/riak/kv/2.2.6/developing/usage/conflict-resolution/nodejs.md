...
toc: true
aliases:
  - /riak-docs/riak/2.2.6/dev/using/conflict-resolution/nodejs
  - /riak-docs/riak/kv/2.2.6/dev/using/conflict-resolution/nodejs
---

For reasons explained in the [Introduction to conflict resolution]({{<baseurl>}}riak/kv/2.2.6/developing/usage/conflict-resolution), we strongly recommend adopting a conflict resolution strategy that
