...
toc: true
aliases:
  - /riak-docs/riak/2.2.6/theory/concepts/Eventual-Consistency
  - /riak-docs/riak/kv/2.2.6/theory/concepts/Eventual-Consistency
  - /riak-docs/riak/2.2.6/theory/concepts/eventual-consistency
  - /riak-docs/riak/kv/2.2.6/theory/concepts/eventual-consistency
---
...
special eventually consistent [Data Types]({{<baseurl>}}riak/kv/2.2.6/developing/data-types/), or you can resolve those
...
or models]({{<baseurl>}}riak/kv/2.2.6/developing/data-modeling/).
