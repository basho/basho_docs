...
toc: true
aliases:
  - /riak-docs/riak/2.2.6/theory/concepts/Replication
  - /riak-docs/riak/kv/2.2.6/theory/concepts/Replication
  - /riak-docs/riak/2.2.6/theory/concepts/replication
  - /riak-docs/riak/kv/2.2.6/theory/concepts/replication
---
...
[concept causal context vc]: {{<baseurl>}}riak/kv/2.2.6/learn/concepts/causal-context/#vector-clocks
...
[usage replication]: {{<baseurl>}}riak/kv/2.2.6/developing/usage/replication
...
bucket's [bucket type]({{<baseurl>}}riak/kv/2.2.6/developing/usage/bucket-types).
...
[Multi-Datacenter Replications]({{<baseurl>}}riak/kv/2.2.6/setup/planning/backend/multi) capabilities.
...
type]({{<baseurl>}}riak/kv/2.2.6/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index]({{<baseurl>}}riak/kv/2.2.6/developing/usage/secondary-indexes/) and
[MapReduce]({{<baseurl>}}riak/kv/2.2.6/developing/usage/mapreduce/) queries. Lowering an object or bucket's
