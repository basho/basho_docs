...
aliases:
  ...
  - /riak/kv/2.2.6/theory/concepts/crdts
---

[crdts pdf]: http://hal.upmc.fr/docs/00/55/55/88/PDF/techreport.pdf
[data types converg]: {{<baseurl>}}riak/kv/2.2.6/learn/concepts/crdts/#convergence
...
[concept causal context dvv]: {{<baseurl>}}riak/kv/2.2.6/learn/concepts/causal-context/#dotted-version-vectors
[concept causal context sib]: {{<baseurl>}}riak/kv/2.2.6/learn/concepts/causal-context/#siblings
...
[dev data types context]: {{<baseurl>}}riak/kv/2.2.6/developing/data-types/#data-types-and-context
