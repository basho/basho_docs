...
toc: true
aliases:
  - /riak-docs/riak/2.2.6/theory/concepts/aae
  - /riak-docs/riak/kv/2.2.6/theory/concepts/aae
---
...
[config aae]: {{<baseurl>}}riak/kv/2.2.6/configuring/reference/#active-anti-entropy
