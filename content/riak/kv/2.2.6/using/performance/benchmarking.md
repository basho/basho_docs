...
toc: true
aliases:
  - /riak-docs/riak/2.2.6/ops/building/benchmarking
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}riak/kv/2.2.6/setup/installing/source/erlang) for instructions
