...
aliases:
  - /riak-docs/riak/2.2.6/ops/mdc/v3/cascading-writes
  - /riak-docs/riak/kv/2.2.6/ops/mdc/v3/cascading-writes
---
...
`riak-repl` command. Please see the [Version 3 Operations guide]({{<baseurl>}}riak/kv/2.2.6/using/cluster-operations/v3-multi-datacenter) for more information.
