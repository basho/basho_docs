...
toc: true
aliases:
  - /riak-docs/riak/2.2.6/ops/mdc/v2/scheduling-fullsync
  - /riak-docs/riak/kv/2.2.6/ops/mdc/v2/scheduling-fullsync
---

{{% note title="Deprecation Warning" %}}
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}riak/kv/2.2.6/using/reference/v3-multi-datacenter/scheduling-fullsync/) instead.
{{% /note %}}
