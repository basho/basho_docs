...
toc: true
aliases:
  - /riak-docs/riak/2.2.6/ops/running/tools/riak
  - /riak-docs/riak/kv/2.2.6/ops/running/tools/riak
---

[configuration file]: {{<baseurl>}}riak/kv/2.2.6/configuring/reference/
[escript]: http://www.erlang.org/doc/man/escript.html
[`riak-admin`]: {{<baseurl>}}riak/kv/2.2.6/using/admin/riak-admin/#top
[configuration]: {{<baseurl>}}riak/kv/2.2.6/configuring/reference/
