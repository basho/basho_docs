...
aliases:
  ...
  - /riak/kv/3.0.12/dev/taste-of-riak/python
---



If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}riak/kv/3.0.12/using/running-a-cluster) first.
...
[CRUD Operations]({{<baseurl>}}riak/kv/3.0.12/developing/getting-started/python/crud-operations)
