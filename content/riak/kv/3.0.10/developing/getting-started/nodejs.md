...
aliases:
  ...
  - /riak/kv/3.0.10/dev/taste-of-riak/nodejs
---
...
If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}riak/kv/3.0.10/using/running-a-cluster) first.
...
[CRUD Operations]({{<baseurl>}}riak/kv/3.0.10/developing/getting-started/nodejs/crud-operations)
