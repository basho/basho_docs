...
toc: true
aliases:
  - /riak/3.0.10/dev/references/http/search-index-info
  - /riak/kv/3.0.10/dev/references/http/search-index-info
---

Retrieves information about all currently available [Search indexes]({{<baseurl>}}riak/kv/3.0.10/developing/usage/search) in JSON format.
