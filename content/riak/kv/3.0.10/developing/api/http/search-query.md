...
toc: true
aliases:
  - /riak/3.0.10/dev/references/http/search-query
  - /riak/kv/3.0.10/dev/references/http/search-query
---

Performs a [Riak KV Search]({{<baseurl>}}riak/kv/3.0.10/developing/usage/search) query.
...
* `q` - The actual Search query itself. Examples can be found in
    [Using Search]({{<baseurl>}}riak/kv/3.0.10/developing/usage/search). If a query is not specified, Riak will return
