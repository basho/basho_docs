...
toc: true
aliases:
  - /riak/3.0.10/ops/advanced/configs/search/
  - /riak/kv/3.0.10/ops/advanced/configs/search/
---
...
[cluster-ops aae throttle]: {{<baseurl>}}riak/kv/3.0.10/using/cluster-operations/active-anti-entropy/#throttling
[config reference]: {{<baseurl>}}riak/kv/3.0.10/configuring/reference
[config reference#search]: {{<baseurl>}}riak/kv/3.0.10/configuring/reference/#search
