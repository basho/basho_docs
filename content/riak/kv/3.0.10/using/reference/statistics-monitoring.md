...
aliases:
  ...
  - /riak/kv/3.0.10/ops/running/stats-and-monitoring
---
...
Riak statistics provided in the [Inspecting a Node]({{<baseurl>}}riak/kv/3.0.10/using/cluster-operations/inspecting-node) and [HTTP Status]({{<baseurl>}}riak/kv/3.0.10/developing/api/http/status) documentation.
...
If graphing all of the [available Riak metrics]({{<baseurl>}}riak/kv/3.0.10/using/cluster-operations/inspecting-node) is
...
[Inspecting a Node]({{<baseurl>}}riak/kv/3.0.10/using/cluster-operations/inspecting-node/#riak admin-status) document.
...
[Riak Control]({{<baseurl>}}riak/kv/3.0.10/using/admin/riak-control/) is Basho's REST-driven user-interface for managing Riak
...
the Riak HTTP [`/stats`]({{<baseurl>}}riak/kv/3.0.10/developing/api/http/status) endpoint is also available.
...
A [Riak New Relic Agent][riak_new_relic] for collecting statistics from the Riak HTTP [`/stats`]({{<baseurl>}}riak/kv/3.0.10/developing/api/http/status) endpoint is also available.
...
[`/stats`]({{<baseurl>}}riak/kv/3.0.10/developing/api/http/status) endpoint.
...
* [Inspecting a Node]({{<baseurl>}}riak/kv/3.0.10/using/cluster-operations/inspecting-node)
* [Riaknostic](http://riaknostic.basho.com)
* [Riak Control]({{<baseurl>}}riak/kv/3.0.10/using/admin/riak-control/)
