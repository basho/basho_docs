...
[upgrade]: /riak/kv/2.0.8/setup/upgrading/cluster/
[rolling restarts]: /riak/kv/2.0.8/using/repair-recovery/rolling-restart/
[add node]: /riak/kv/2.0.8/using/cluster-operations/adding-removing-nodes
