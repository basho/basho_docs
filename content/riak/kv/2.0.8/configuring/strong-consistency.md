...
[config reference#strong-cons]: {{<baseurl>}}riak/kv/2.0.8/configuring/reference/#strong-consistency
...
[use admin riak-admin#ensemble]: {{<baseurl>}}riak/kv/2.0.8/using/admin/riak-admin/#ensemble-status
