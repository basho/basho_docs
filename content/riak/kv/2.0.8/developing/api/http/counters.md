...
The regular POST/PUT ([HTTP Store Object](/riak/kv/2.0.8/developing/api/http/store-object)) and GET ([HTTP Fetch Object](/riak/kv/2.0.8/developing/api/http/fetch-object)) responses apply here.
