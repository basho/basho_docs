...
aliases:
  ...
  - /riak/kv/2.0.8/dev/references/http/set-bucket-props
---
...
clock) when writing
* `precommit` - [precommit hooks]({{<baseurl>}}riak/kv/2.0.8/developing/usage/commit-hooks)
* `postcommit` - [postcommit hooks]({{<baseurl>}}riak/kv/2.0.8/developing/usage/commit-hooks)
