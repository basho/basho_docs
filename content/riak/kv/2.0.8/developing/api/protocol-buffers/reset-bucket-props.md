...
aliases:
  ...
  - /riak/kv/2.0.8/dev/references/protocol-buffers/reset-bucket-props
---
...
[bucket type]({{<baseurl>}}riak/kv/2.0.8/developing/usage/bucket-types) using the `type` value. If you do not
