...
aliases:
  ...
  - /riak/kv/2.0.8/dev/references/protocol-buffers/yz-schema-get
---

Fetch a [search schema]({{<baseurl>}}riak/kv/2.0.8/developing/usage/search-schemas) from Riak Search.
