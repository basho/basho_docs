...
aliases:
  ...
  - /riak/kv/2.0.8/dev/using/conflict-resolution/ruby
---
...
the official Ruby client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/2.0.8/developing/usage) section.
