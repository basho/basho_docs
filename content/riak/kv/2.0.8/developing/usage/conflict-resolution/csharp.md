...
For reasons explained in the [Introduction to conflict resolution](/riak/kv/2.0.8/developing/usage/conflict-resolution), we strongly recommend adopting a conflict resolution strategy that requires applications to resolve siblings according to use-case-specific
