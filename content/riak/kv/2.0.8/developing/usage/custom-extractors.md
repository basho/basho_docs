...
There are also built-in extractors for [Riak Data Types](/riak/kv/2.0.8/developing/usage/searching-data-types).
...
can be found in our documentation on [advanced](/riak/kv/2.0.8/configuring/reference/#advanced-configuration)). Here's an
example:
...
create a schema that extends the [default schema](/riak/kv/2.0.8/developing/usage/search-schemas/#creating-a-custom-schema). The following fields should be added
...
Now, we can create and activate a [bucket type](/riak/kv/2.0.8/developing/usage/bucket-types)
