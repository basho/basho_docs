...
features recently added to Riak---[Riak Search](/riak/kv/2.0.8/developing/usage/search/) and [Riak Data Types](/riak/kv/2.0.8/developing/data-types/)---make it possible to use Riak as a
...
[Riak maps](/riak/kv/2.0.8/developing/data-types/#maps).
...
however, we will store data in [Riak maps](/riak/kv/2.0.8/developing/data-types/#maps),
...
In the documentation on [search schemas](/riak/kv/2.0.8/developing/usage/search-schemas), you'll find a
