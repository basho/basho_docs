...
aliases:
  ...
  - /riak/kv/2.0.8/theory/concepts/Replication
  - /riak/2.0.8/theory/concepts/replication
  - /riak/kv/2.0.8/theory/concepts/replication
---
...
[concept causal context vc]: /riak/kv/2.0.8/learn/concepts/causal-context/#vector-clocks
...
[glossary ring]: /riak/kv/2.0.8/learn/glossary/#ring
...
bucket's [bucket type](/riak/kv/2.0.8/developing/usage/bucket-types).
...
[Multi-Datacenter Replications](/riak/kv/2.0.8/setup/planning/backend/multi) capabilities.
...
type](/riak/kv/2.0.8/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index](/riak/kv/2.0.8/developing/usage/secondary-indexes/) and
[MapReduce](/riak/kv/2.0.8/developing/usage/mapreduce/) queries. Lowering an object or bucket's
