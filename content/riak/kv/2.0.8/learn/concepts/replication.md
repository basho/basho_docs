...
[glossary ring]: {{<baseurl>}}riak/kv/2.0.8/learn/glossary/#ring
...
bucket's [bucket type]({{<baseurl>}}riak/kv/2.0.8/developing/usage/bucket-types).
...
[Multi-Datacenter Replications]({{<baseurl>}}riak/kv/2.0.8/setup/planning/backend/multi) capabilities.
...
type]({{<baseurl>}}riak/kv/2.0.8/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index]({{<baseurl>}}riak/kv/2.0.8/developing/usage/secondary-indexes/) and
[MapReduce]({{<baseurl>}}riak/kv/2.0.8/developing/usage/mapreduce/) queries. Lowering an object or bucket's
