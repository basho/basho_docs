...
[concept replication aae]: {{<baseurl>}}riak/kv/2.0.8/learn/concepts/replication/#active-anti-entropy
...
[repair recover failure recovery]: {{<baseurl>}}riak/kv/2.0.8/using/repair-recovery/failure-recovery
[repair recover repairs]: {{<baseurl>}}riak/kv/2.0.8/using/repair-recovery/repairs
...
* [Bucket Types]({{<baseurl>}}riak/kv/2.0.8/developing/usage/bucket-types)
