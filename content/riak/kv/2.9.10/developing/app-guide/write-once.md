...
aliases:
  ...
  - /riak/kv/2.9.10/dev/advanced/write-once
---
...
[strong consistency]: {{<baseurl>}}riak/kv/2.9.10/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}riak/kv/2.9.10/setup/planning/backend/multi) backend does not
