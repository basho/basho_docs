...
aliases:
  ...
  - /riak/kv/2.9.10/dev/references/protocol-buffers/reset-bucket-props
---
...
[bucket type]({{<baseurl>}}riak/kv/2.9.10/developing/usage/bucket-types) using the `type` value. If you do not
