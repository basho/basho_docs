...
[rolling restarts]: {{<baseurl>}}riak/kv/2.9.10/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}riak/kv/2.9.10/using/cluster-operations/adding-removing-nodes
