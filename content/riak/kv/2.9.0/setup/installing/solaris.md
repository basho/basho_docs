...
toc: true
aliases:
  - /riak-docs/riak/2.9.0/ops/building/installing/Installing-on-Solaris
  - /riak-docs/riak/kv/2.9.0/ops/building/installing/Installing-on-Solaris
  - /riak-docs/riak/2.9.0/installing/solaris/
  - /riak-docs/riak/kv/2.9.0/installing/solaris/
---
...
```bash
curl -o /tmp/BASHOriak-2.9.0-Solaris10-i386.pkg.gz https://files.tiot.jp/riak/kv/2.2/2.2.0/solaris/10/BASHOriak-2.2.0-Solaris10-x86_64.pkg.gz
```

Next, install the package:

```bash
gunzip /tmp/BASHOriak-2.9.0-Solaris10-i386.pkg.gz
pkgadd /tmp/BASHOriak-2.9.0-Solaris10-i386.pkg
```
