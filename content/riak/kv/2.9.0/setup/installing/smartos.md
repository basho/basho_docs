...
toc: true
aliases:
  - /riak-docs/riak/2.9.0/ops/building/installing/Installing-on-SmartOS
  - /riak-docs/riak/kv/2.9.0/ops/building/installing/Installing-on-SmartOS
  - /riak-docs/riak/2.9.0/installing/smartos/
  - /riak-docs/riak/kv/2.9.0/installing/smartos/
---
...
```bash
curl -o /tmp/riak-2.9.0-SmartOS-x86_64.tgz https://files.tiot.jp/riak/kv/1.2/1.2.0/smartos/1.8/riak-1.2.0-SmartOS-x86_64.tgz
```

Next, install the package:

```
pkg_add /tmp/riak-1.2.0-SmartOS-x86_64.tgz
```
