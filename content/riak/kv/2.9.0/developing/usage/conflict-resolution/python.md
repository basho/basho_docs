...
toc: true
aliases:
  - /riak-docs/riak/2.9.0/dev/using/conflict-resolution/python
  - /riak-docs/riak/kv/2.9.0/dev/using/conflict-resolution/python
---
...
from the official Python client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/2.9.0/developing/usage) section.
