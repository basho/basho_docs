...
toc: true
aliases:
  - /riak-docs/riak/2.9.0/dev/taste-of-riak/python
  - /riak-docs/riak/kv/2.9.0/dev/taste-of-riak/python
---
...
[CRUD Operations]({{<baseurl>}}riak/kv/2.9.0/developing/getting-started/python/crud-operations)
