...
`pr` | PR | `0` | The number of primary <a href="http://docs.basho.com/riak/kv/2.9.0/learn/concepts/vnodes/">vnodes</a> that must respond to a read request
`pw` | PW | `0` | The number of primary <a href="http://docs.basho.com/riak/kv/2.9.0/learn/concepts/vnodes/">vnodes</a> that must respond to a write request
