...
aliases:
  ...
  - /riak/kv/3.0.3/ops/building/configuration/
---
...
[Cluster Capacity Planning]: {{<baseurl>}}riak/kv/3.0.3/setup/planning/cluster-capacity/#ring-size-number-of-partitions
...
directly impacted, although the mechanism described in [HTTP Reset Bucket Properties]({{<baseurl>}}riak/kv/3.0.3/developing/api/http/reset-bucket-props) can be used to force them to pick up the new
defaults.
