...
aliases:
  ...
  - /riak/kv/3.0.3/ops/upgrading/rolling-upgrades/
  - /riak/kv/3.0.3/ops/upgrading/rolling-upgrades/
  - /riak/kv/3.0.3/setup/upgrading/cluster/
...
[release notes]: {{<baseurl>}}riak/kv/3.0.3/release-notes
...
[jmx monitor]: {{<baseurl>}}riak/kv/3.0.3/using/reference/jmx
[snmp]: {{<baseurl>}}riak/kv/3.0.3/using/reference/snmp
[Release Notes]: {{<baseurl>}}riak/kv/3.0.3/release-notes
...
{{% note %}}
You must have [Java version 7 or higher](http://www.oracle.com/technetwork/java/javase/downloads/index.html) in order to upgrade to Riak KV 3.0.3 only if you plan to use Riak search.
{{% /note %}}
