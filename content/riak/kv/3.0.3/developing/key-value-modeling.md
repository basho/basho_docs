...
that can be useful in application development, such as [secondary indexes (2i)]({{<baseurl>}}riak/kv/3.0.3/developing/usage/secondary-indexes/), and [Riak Data Types]({{<baseurl>}}riak/kv/3.0.3/developing/data-types/), Riak almost always performs best when you
