...
toc: true
aliases:
  - /riak/3.0.3/dev/references/protocol-buffers/yz-schema-get
  - /riak/kv/3.0.3/dev/references/protocol-buffers/yz-schema-get
---

Fetch a [search schema]({{<baseurl>}}riak/kv/3.0.3/developing/usage/search-schemas) from Riak Search.
