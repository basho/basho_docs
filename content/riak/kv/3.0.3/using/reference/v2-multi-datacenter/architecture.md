...
aliases:
  ...
  - /riak/kv/3.0.3/ops/mdc/v2/architecture
---
...
2. The site node in the secondary cluster initiates fullsync replication
   ...
   the primary cluster
3. The site and listener nodes iterate through each [vnode]({{<baseurl>}}riak/kv/3.0.3/learn/glossary/#vnode) in their respective clusters and compute a hash for
