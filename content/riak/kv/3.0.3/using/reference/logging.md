...
aliases:
  ...
  - /riak/kv/3.0.3/ops/running/logging
---
...
* `console` - Console logs will be emitted to standard output, which
    can be viewed by running the [`riak attach-direct`]({{<baseurl>}}riak/kv/3.0.3/using/admin/riak-cli/#attach-direct) command
