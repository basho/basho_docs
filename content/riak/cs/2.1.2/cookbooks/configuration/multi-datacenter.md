...
Though there is no specific configuration for [Stanchion]({{<baseurl>}}riak/cs/2.1.2/theory/stanchion), note that
...
updates to [globally unique entities]({{<baseurl>}}riak/cs/2.1.2/theory/stanchion/#globally-unique-entities) like users and buckets.
