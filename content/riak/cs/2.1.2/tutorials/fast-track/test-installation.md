...
aliases:
  ...
  - /riak/cs/2.1.2/cookbooks/tutorials/fast-track/Testing-the-Installation/
...
* [Details about API operations]({{<baseurl>}}riak/cs/2.1.2/references/apis/storage)
* [Information about the Ruby Fog client]({{<baseurl>}}riak/cs/2.1.2/cookbooks/fog)
* [Release Notes]({{<baseurl>}}riak/cs/2.1.2/cookbooks/release-notes)
