...
aliases:
  ...
  - /riak/cs/2.1.2/references/apis/storage/s3/RiakCS-PUT-Bucket-policy/
  - /riak/cs/latest/references/apis/storage/s3/put-bucket-policy/
---
...
This operation uses only request headers that are common to all operations. For more information, see [Common Riak CS Request Headers]({{<baseurl>}}riak/cs/2.1.2/references/apis/storage/s3/common-request-headers).
