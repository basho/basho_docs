...
aliases:
  ...
  - /riak/cs/2.1.2/references/apis/storage/
...
* [Mapping]({{<baseurl>}}riak/cs/2.1.2/references/apis/storage/s3/mapping-from-s3-api-to-riak-cs-internal-api)
...
* [Mapping]({{<baseurl>}}riak/cs/2.1.2/references/apis/storage/openstack/mapping-from-oos-api-to-riak-cs-internal-api)
...
* [S3 API]({{<baseurl>}}riak/cs/2.1.2/references/apis/storage/s3/)
* [OpenStack API]({{<baseurl>}}riak/cs/2.1.2/references/apis/storage/openstack/)
