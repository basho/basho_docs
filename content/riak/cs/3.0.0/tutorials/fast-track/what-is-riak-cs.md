...
When an object is uploaded via the [storage API]({{<baseurl>}}riak/cs/3.0.0/references/apis/storage), Riak CS breaks the object into smaller chunks that are streamed,
