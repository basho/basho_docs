...
aliases:
  ...
  - /riak/cs/3.0.0/cookbooks/tutorials/fast-track/Building-a-Local-Test-Environment/
...
configuration, there is an option for [Building a Virtual Testing Environment]({{<baseurl>}}riak/cs/3.0.0/tutorials/fast-track/virtual-test-environment).
...
[Download Riak]({{<baseurl>}}riak/kv/latest/downloads/) and [Download Riak CS]({{<baseurl>}}riak/cs/3.0.0/downloads).
...
Once you have completed this step, You can progress to [testing the Riak CS installation]({{<baseurl>}}riak/cs/3.0.0/tutorials/fast-track/test-installation) using s3cmd.
