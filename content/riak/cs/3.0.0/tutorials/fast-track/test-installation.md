...
aliases:
  ...
  - /riak/cs/3.0.0/cookbooks/tutorials/fast-track/Testing-the-Installation/
...
* [Details about API operations]({{<baseurl>}}riak/cs/3.0.0/references/apis/storage)
* [Information about the Ruby Fog client]({{<baseurl>}}riak/cs/3.0.0/cookbooks/fog)
* [Release Notes]({{<baseurl>}}riak/cs/3.0.0/cookbooks/release-notes)
