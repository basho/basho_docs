...
3. Set your desired Stanchion [configuration]({{<baseurl>}}riak/cs/3.0.0/cookbooks/configuration/stanchion)
...
in our documentation on [Riak CS Command Line Tools]({{<baseurl>}}riak/cs/3.0.0/cookbooks/command-line-tools/#riak-cs-supercluster).
