...
useful for local testing with Riak CS can be found [here]({{<baseurl>}}riak/cs/3.0.0/cookbooks/keystone-conf-sample/). This configuration file sets up logging to
