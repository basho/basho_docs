...
aliases:
  ...
  - /riak/cs/2.0.0/theory/stanchion/
---
...
* [Installing Stanchion]({{<baseurl>}}riak/cs/2.0.0/cookbooks/installing#installing-stanchion-on-a-node)
* [The Stantion Command-line Interface]({{<baseurl>}}riak/cs/2.0.0/cookbooks/command-line-tools#stanchion)
