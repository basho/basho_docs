...
aliases:
  ...
  - /riak/cs/2.0.0/cookbooks/garbage-collection/
---
...
For more information, see our documentation on [Riak CS command-line tools](/riak/cs/2.0.0/cookbooks/command-line-tools).
