...
aliases:
  - /riakcs/2.0.1/cookbooks/Load-Balancing-and-Proxy-Configuration/
  - /riak/cs/2.0.1/cookbooks/Load-Balancing-and-Proxy-Configuration/
---
...
recommend consulting the [configuring Riak CS](/riak/cs/2.0.1/cookbooks/configuration/riak-cs) tutorial.
...
corresponding settings in the <a href="/riak/cs/2.0.1/theory/stanchion">Stanchion</a> node's <code>stanchion.conf</code>.
</td>
<td><code>admin-key</code></td>
</tr>
<tr>
...
a particular API to requests in the the native <a href="/riak/cs/2.0.1/references/apis/storage">Riak CS storage API</a>. We do
...
corresponding settings in the <a href="/riak/cs/2.0.1/theory/stanchion">Stanchion</a> node's
...
made using a particular API to requests in the the native <a href="/riak/cs/2.0.1/references/apis/storage">Riak CS storage API</a>. We do not recommend changing this setting unless you
...
These settings relate to Riak CS's [access logs](/riak/cs/2.0.1/cookbooks/usage-and-billing-data).
...
Settings related to Riak CS's [garbage collection](/riak/cs/2.0.1/cookbooks/garbage-collection) \(GC) process.
...
features for the current version to better support <a href="/riak/cs/2.0.1/cookbooks/rolling-upgrades">rolling upgrades</a>. New
...
enable new features for the current version to better support <a href="/riak/cs/2.0.1/cookbooks/rolling-ugrades">rolling upgrades</a>. New installs shouldn't need to modify this. If you're performing a rolling upgrade, keep the original value (if not defined, Riak CS uses <code>0</code>) of the old <code>app.config</code> until all nodes have been upgraded. At that point, set to the new value.</td>
<td><code></code></td>
</tr>
<tr>
