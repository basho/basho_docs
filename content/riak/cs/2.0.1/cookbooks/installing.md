...
aliases:
  ...
  - /riak/cs/2.0.1/cookbooks/installing/Installing-Riak-CS/
---
...
* [Riak KV](/riak/2.0.7/) --- The distributed database on top of which Riak CS 
is built
* Riak CS itself
...
We strongly recommend using one of the documented [version combinations](/riak/cs/2.0.1/cookbooks/version-compatibility/) 
...
or from source.
  ...
  * [Debian and Ubuntu](/riak/kv/2.0.7/setup/installing/debian-ubuntu)
  * [RHEL and CentOS](/riak/kv/2.0.7/setup/installing/rhel-centos)
  * [Mac OS X](/riak/kv/2.0.7/setup/installing/mac-osx)
  * [FreeBSD](/riak/kv/2.0.7/setup/installing/freebsd)
  * [SUSE](/riak/kv/2.0.7/setup/installing/suse)
  * [From Source](/riak/kv/2.0.7/setup/installing/source)

Riak KV is also officially supported on the following public cloud
infrastructures:

  * [Windows Azure](/riak/kv/2.0.7/setup/installing/windows-azure)
  * [AWS Marketplace](/riak/kv/2.0.7/setup/installing/amazon-web-services)
...
documentation on [configuring Riak KV for CS](/riak/cs/2.0.1/cookbooks/configuration/riak-for-cs/).

## Installing Riak CS on a Node

Riak CS and Stanchion packages are available on the [Download Riak CS](/riak/cs/2.0.1/downloads/)
page. Similarly, Riak packages are available on the [Download Riak KV](/riak/kv/2.0.7/downloads/) page.
...
the [downloads](/riak/cs/2.0.1/downloads) page:

```bash
curl -O http://s3.amazonaws.com/downloads.basho.com/riak-cs/1.5/2.0.1/osx/10.8/riak-cs-2.0.1-OSX-x86_64.tar.gz
```
...
At this point, you can move on to [configuring Riak CS](/riak/cs/2.0.1/cookbooks/configuration/riak-cs/).
...
* [Lucid](https://packagecloud.io/basho/riak-cs/riak-cs_2.0.1-1_amd64.deb?distro=lucid)
* [Precise](https://packagecloud.io/basho/riak-cs/riak-cs_2.0.1-1_amd64.deb?distro=precise)
* [Squeeze](https://packagecloud.io/basho/riak-cs/riak-cs_2.0.1-1_amd64.deb?distro=squeeze)
* [Trusty](https://packagecloud.io/basho/riak-cs/riak-cs_2.0.1-1_amd64.deb?distro=trusty)
* [Wheezy](https://packagecloud.io/basho/riak-cs/riak-cs_2.0.1-1_amd64.deb?distro=wheezy)
...
* [el5](https://packagecloud.io/basho/riak-cs/riak-cs-2.0.1-1.x86_64.rpm?distro=5)
* [el6](https://packagecloud.io/basho/riak-cs/packages/el/6/riak-cs-2.0.1-1.el6.x86_64.rpm)
<!-- * [el7](https://packagecloud.io/basho/riak-cs/riak-cs-2.0.1-1.x86_64.rpm?distro=7) -->
* [Fedora 19](https://packagecloud.io/basho/riak-cs/riak-cs-2.0.1-1.fc19.x86_64.rpm?distro=19)
...
learn more about [configuring Riak CS](/riak/cs/2.0.1/cookbooks/configuration/riak-cs).
