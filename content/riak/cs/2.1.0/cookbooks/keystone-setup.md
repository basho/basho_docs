...
aliases:
  ...
  - /riak/cs/2.1.0/cookbooks/Keystone-Setup/
---
...
useful for local testing with Riak CS can be found [here](/riak/cs/2.1.0/cookbooks/keystone-conf-sample/). This configuration file sets up logging to
