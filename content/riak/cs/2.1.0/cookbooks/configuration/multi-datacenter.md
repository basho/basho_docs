...
Though there is no specific configuration for [Stanchion](/riak/cs/2.1.0/theory/stanchion), note that
...
updates to [globally unique entities](/riak/cs/2.1.0/theory/stanchion/#globally-unique-entities) like users and buckets.
