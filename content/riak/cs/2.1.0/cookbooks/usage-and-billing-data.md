...
aliases:
  ...
  - /riak/cs/2.1.0/cookbooks/Usage-and-Billing-Data/
---
...
please read [Querying Access Statistics](/riak/cs/2.1.0/cookbooks/querying-access-statistics).
...
query parameter is a `KeyWrite` operation. See [Querying Access Statistics](/riak/cs/2.1.0/cookbooks/querying-access-statistics) for a list of all operation types.
...
See [Configuring Riak for CS](/riak/cs/2.1.0/cookbooks/configuration/riak-for-cs) for directions on setting this up.
