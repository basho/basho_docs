...
aliases:
  ...
  - /riak/cs/2.1.0/cookbooks/tutorials/fast-track/Building-a-Virtual-Test-Environment/
---
...
instructions for [Building a Local Test Environment]({{<baseurl>}}riak/cs/2.1.0/tutorials/fast-track/local-testing-environment).
...
You are ready to progress to [Testing the Riak CS Installation]({{<baseurl>}}riak/cs/2.1.0/tutorials/fast-track/test-installation).
