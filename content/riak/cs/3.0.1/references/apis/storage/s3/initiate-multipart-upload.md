...
aliases:
  ...
  - /riak/cs/3.0.1/references/apis/storage/s3/RiakCS-Initiate-Multipart-Upload/
...
This implementation of the operation uses only response headers that are common to most responses. For more information, see [Common RiakCS Response Headers]({{<baseurl>}}riak/cs/3.0.1/references/apis/storage/s3/common-response-headers).
