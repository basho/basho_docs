...
aliases:
  ...
  - /riak/cs/3.0.1/theory/stanchion/
...
* [Installing Stanchion]({{<baseurl>}}riak/cs/3.0.1/cookbooks/installing#installing-stanchion-on-a-node)
* [The Stantion Command-line Interface]({{<baseurl>}}riak/cs/3.0.1/cookbooks/command-line-tools#stanchion)
