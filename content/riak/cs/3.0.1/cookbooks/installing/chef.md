...
aliases:
  ...
  - /riak/cs/3.0.1/cookbooks/installing/Riak-CS-Using-Chef/
...
* [Building a Local Test Environment]({{<baseurl>}}riak/cs/3.0.1/tutorials/fast-track/local-testing-environment)
* [Building a Virtual Testing Environment]({{<baseurl>}}riak/cs/3.0.1/tutorials/fast-track/virtual-test-environment)
