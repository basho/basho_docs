...
aliases:
  ...
  - /riak/cs/3.0.1/cookbooks/configuration/Configuring-MDC/
...
Though there is no specific configuration for [Stanchion]({{<baseurl>}}riak/cs/3.0.1/theory/stanchion), note that
...
updates to [globally unique entities]({{<baseurl>}}riak/cs/3.0.1/theory/stanchion/#globally-unique-entities) like users and buckets.
