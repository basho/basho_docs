...
please read [Querying Access Statistics]({{<baseurl>}}riak/cs/3.0.1/cookbooks/querying-access-statistics).
...
query parameter is a `KeyWrite` operation. See [Querying Access Statistics]({{<baseurl>}}riak/cs/3.0.1/cookbooks/querying-access-statistics) for a list of all operation types.
...
See [Configuring Riak for CS]({{<baseurl>}}riak/cs/3.0.1/cookbooks/configuration/riak-for-cs) for directions on setting this up.
