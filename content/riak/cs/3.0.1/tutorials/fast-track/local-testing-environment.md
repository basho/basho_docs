...
aliases:
  ...
  - /riak/cs/3.0.1/cookbooks/tutorials/fast-track/Building-a-Local-Test-Environment/
  - /riak/cs/latest/tutorials/fast-track/local-testing-environment/
---
...
configuration, there is an option for [Building a Virtual Testing Environment]({{<baseurl>}}riak/cs/3.0.1/tutorials/fast-track/virtual-test-environment).
...
[Download Riak]({{<baseurl>}}riak/kv/latest/downloads/) and [Download Riak CS]({{<baseurl>}}riak/cs/3.0.1/downloads).
...
Once you have completed this step, You can progress to [testing the Riak CS installation]({{<baseurl>}}riak/cs/3.0.1/tutorials/fast-track/test-installation) using s3cmd.
